function  [phi,im,dat,flat]=RecoLoopMeshes2(ScanNum,DistNum,alpha)
...
ttotal = 0;
% Loop over data.
ii = ScanNum, % Loop over samples defined in ScanName.
    jj = DistNum, % Loop over distances within scan.
