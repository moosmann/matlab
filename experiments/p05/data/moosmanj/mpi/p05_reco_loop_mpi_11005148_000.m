function p05_reco_loop_mpi_11005148_000( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 18-Oct-2018 by felix
...
%%% SCAN %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
scan_path = ...
'/asap3/petra3/gpfs/p07/2018/data/11005148/raw/mpi01_rmh_ca_24_6_ulp3_a';
...
%%% PREPROCESSING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_roi = [700 3300]; % if []: use full image; if [y0 y1]: vertical ROI, skips first raw_roi(1)-1 lines, reads until raw_roi(2). When raw_roi(2) < 0 reads until end - |raw_roi(2)|; if negative scalar: auto roi, selects ROI automatically.Not working for *.raw data where images are flipped.
...
stitch_method = 'step';'sine';'linear'; %  ! CHECK correlation area !
...
ring_filter.waveletfft.wname = 'db30';'db25'; % wavelet type, see 'FilterStripesCombinedWaveletFFT' or 'waveinfo'
...
tomo.vol_size = [-0.8 0.8 -0.8 0.8 -0.8 0.8]; %[-1 1 -1 1 -1 1];%[-0.5 0.5 -0.5 0.5 -0.5 0.5];% 6-component vector [xmin xmax ymin ymax zmin zmax], for excentric rot axis pos / extended FoV;. if empty, volume is centerd within tomo.vol_shape. unit voxel size is assumed. if smaller than 10 values are interpreted as relative size w.r.t. the detector size. Take care bout minus signs! Note that if empty vol_size is dependent on the rotation axis position.
...
tomo.rot_axis.offset = -2.85;%[];%-2.5;[];% if empty use automatic computation
...
tomo.algorithm = 'fbp';'sirt'; 'cgls';'sart';'em';'fbp-astra'; % SART/EM only work in 2D slicewise reco mode
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2018/data/11005148/raw/';

tomo.rot_axis.offset = -2.85;
scan_path = [raw_path 'mpi01_rmh_ca_24_6_ulp3_a']; ADD

tomo.rot_axis.offset = -1.2;
scan_path = [raw_path 'mpi01_rmh_ca_24_6_ulp3_b']; ADD

tomo.rot_axis.offset = -0.15;
scan_path = [raw_path 'mpi01_rmh_ca_24_6_ulp3_c']; ADD

tomo.rot_axis.offset = 1;
scan_path = [raw_path 'mpi01_rmh_ca_24_6_ulp3_d']; ADD

tomo.rot_axis.offset = 1.9;
scan_path = [raw_path 'mpi01_rmh_ca_24_6_ulp3_e']; ADD

tomo.rot_axis.offset = 3;
scan_path = [raw_path 'mpi01_rmh_ca_24_6_ulp3_f']; ADD

scan_path = [raw_path 'mpi02_rmh_ca_24_6_ulp3_a']; ADD

scan_path = [raw_path 'mpi02_rmh_ca_24_6_ulp3_b']; ADD

scan_path = [raw_path 'mpi02_rmh_ca_24_6_ulp3_c']; ADD

scan_path = [raw_path 'mpi02_rmh_ca_24_6_ulp3_d']; ADD

% aborted
%scan_path = [raw_path 'mpi02_rmh_ca_24_6_ulp3_e']; ADD

scan_path = [raw_path 'mpi02_rmh_ca_24_6_ulp3_ee']; ADD

%raw_roi = [1900 2100];
raw_roi = [700 3300]; 
tomo.rot_axis.offset = -0.5;
scan_path = [raw_path 'mpi03_rmh_ca_24_6_ulp3_a']; ADD
...
raw_bin = 4;
proj_range = 1:6742;
tomo.rot_axis.offset = 8.55 * 3 / raw_bin;
raw_roi = [700 3300]; 
...
write.sino = 0;
write.phase_sino = 0;
scan_path = [raw_path 'mpi05_rmh_ca_14_9_urp3_ee']; ADD('r')
...
raw_roi = [700 3300]; 
bin_before_filtering = 1;
image_correlation.method = 'none';'ssim-ml';
...
write.sino = 0;
write.phase_sino = 0;
scan_path = [raw_path 'mpi10_e129_rmh_ca_14_9_urp3_e']; ADD('r')
