function p05_reco_loop_bmc_11010107_000( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 12-May-2020 by moosmanj
...
%%% PREPROCESSING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_roi = -1;[];%[0.3 0.7]; % vertical and/or horizontal ROI; (1,1) coordinate = top left pixel; supports absolute, relative, negative, and mixed indexing.
% []: use full image;
...
write.beamtimeID = '11010107'; % string (regexp),typically beamtime ID, mandatory if 'write.deleteFiles' is true (safety check)
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p05/2020/data/11010107/raw/';

raw_bin = 2;
tomo.rot_axis_offset = 4.6;
s = sprintf( 'sino_rawBin%u_rao%07.2f', raw_bin, tomo.rot_axis_offset );
s = regexprep( s, '\.', 'p' );
write.subfolder_sino = s;

scan_path = [raw_path 'bmc02_v72r08_a']; ADD
scan_path = [raw_path 'bmc02_v72r08_b']; ADD
write.sino = 1;
scan_path = [raw_path 'bmc02_v72r08_c']; ADD
scan_path = [raw_path 'bmc02_v72r08_d']; ADD
write.sino = 0;
scan_path = [raw_path 'bmc02_v72r08_e']; ADD
scan_path = [raw_path 'bmc02_v72r08_f']; ADD
scan_path = [raw_path 'bmc02_v72r08_g']; ADD

scan_path = [raw_path 'bmc03_v70l_a']; ADD
scan_path = [raw_path 'bmc03_v70l_b']; ADD
scan_path = [raw_path 'bmc03_v70l_c']; ADD
write.sino = 1;
scan_path = [raw_path 'bmc03_v70l_d']; ADD
scan_path = [raw_path 'bmc03_v70l_e']; ADD
write.sino = 0;
scan_path = [raw_path 'bmc03_v70l_f']; ADD
scan_path = [raw_path 'bmc03_v70l_g']; ADD

scan_path = [raw_path 'bmc04_v72l_a']; ADD
scan_path = [raw_path 'bmc04_v72l_b']; ADD
scan_path = [raw_path 'bmc04_v72l_c']; ADD
write.sino = 1;
scan_path = [raw_path 'bmc04_v72l_d']; ADD
scan_path = [raw_path 'bmc04_v72l_e']; ADD
write.sino = 0;
scan_path = [raw_path 'bmc04_v72l_f']; ADD
scan_path = [raw_path 'bmc04_v72l_g']; ADD

raw_roi = [1140 2850];
tomo.vol_shape = [2470 2470 855];
tomo.vol_size = [-1230.500000 1230.500000 -1230.500000 1230.500000 -427.500000 427.500000];
tomo.rot_axis_offset = 4.6;
scan_path = [raw_path 'bmc04_v72l_g_fly_nospiral']; ADD
scan_path = [raw_path 'bmc04_v72l_g_fly_spiral_zshift0500']; ADD
scan_path = [raw_path 'bmc04_v72l_g_fly_spiral_zshift1000']; ADD

tomo.rot_axis_offset = 4.0;
tomo.vol_size = [-0.8 0.8 -0.8 0.8 -0.5 0.5];
norm_sino = 0;
scan_path = [raw_path 'bmc05_v63l_a']; ADD
scan_path = [raw_path 'bmc05_v63l_b']; ADD
scan_path = [raw_path 'bmc05_v63l_c']; ADD
scan_path = [raw_path 'bmc05_v63l_d']; ADD
scan_path = [raw_path 'bmc05_v63l_e']; ADD
scan_path = [raw_path 'bmc05_v63l_f']; ADD
scan_path = [raw_path 'bmc05_v63l_g']; ADD
