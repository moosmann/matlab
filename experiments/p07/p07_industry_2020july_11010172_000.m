function p07_industry_2020july_11010172_000( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 22-Jun-2020 by moosmanj
...
tomo.vol_size = [-0.5 1 -0.5 0.75 -0.5 0.5];%[];% 6-component vector [xmin xmax ymin ymax zmin zmax], for excentric rot axis pos / extended FoV;. if empty, volume is centerd within tomo.vol_shape. unit voxel size is assumed. if smaller than 10 values are interpreted as relative size w.r.t. the detector size. Take care bout minus signs! Note that if empty vol_size is dependent on the rotation axis position.
...
write.beamtimeID = '11010172'; % string (regexp),typically beamtime ID, mandatory if 'write.deleteFiles' is true (safety check)
...
interactive_mode.slice_number = 0.9; % default slice number. if in [0,1): relative, if in (1, N]: absolute
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2020/data/11010172/raw/';

tomo.rot_axis_offset = -9.375 * 2 / raw_bin;
par.visual_output = 1;
interactive_mode.rot_axis_pos = 0;
tomo.vol_size = [-0.3   0.3 -0.3 0.3 -0.5 0.5];

scan_path = [raw_path 'swerim_01_12_oh_a']; ADD

scan_path = [raw_path 'swerim_02_12_m_a']; ADD

scan_path = [raw_path 'swerim_03_12_nh_a']; ADD

scan_path = [raw_path 'swerim_04_28_oh_a']; ADD

scan_path = [raw_path 'swerim_05_28_m_a']; ADD

scan_path = [raw_path 'swerim_06_28_nh_a']; ADD

scan_path = [raw_path 'swerim_07_33_oh_a']; ADD

scan_path = [raw_path 'swerim_08_33_m_a']; ADD

scan_path = [raw_path 'swerim_09_33_nh_a']; ADD

scan_path = [raw_path 'swerim_10_43_oh_a']; ADD

scan_path = [raw_path 'swerim_11_43_m_a']; ADD

scan_path = [raw_path 'swerim_12_43_nh_a']; ADD

scan_path = [raw_path 'swerim_13_51_oh_a']; ADD

scan_path = [raw_path 'swerim_14_51_m_a']; ADD

scan_path = [raw_path 'swerim_15_51_nh_a']; ADD

scan_path = [raw_path 'swerim_16_af_band_a']; ADD

% 3D mode: [ left right up down
tomo.vol_size = [-0.45 0.2 -0.45 0.2 -0.49 0.49];

scan_path = [raw_path 'swerim_21_12_oh_a']; ADD

scan_path = [raw_path 'swerim_22_12_m_a']; ADD

scan_path = [raw_path 'swerim_23_12_nh_a']; ADD

scan_path = [raw_path 'swerim_24_28_oh_a']; ADD

scan_path = [raw_path 'swerim_25_28_m_a']; ADD

scan_path = [raw_path 'swerim_26_28_nh_a']; ADD

tomo.vol_size = [-0.45 0.2 -0.3 0.35 -0.49 0.49];
scan_path = [raw_path 'swerim_27_33_oh_a']; ADD

scan_path = [raw_path 'swerim_28_33_m_a']; ADD

tomo.vol_size = [-0.45 0.2 -0.3 0.35 -0.49 0.49];
scan_path = [raw_path 'swerim_29_33_nh_a']; ADD

scan_path = [raw_path 'swerim_30_43_oh_a']; ADD

scan_path = [raw_path 'swerim_31_43_m_a']; ADD

tomo.vol_size = [-0.45 0.2 -0.3 0.35 -0.49 0.49];
scan_path = [raw_path 'swerim_32_43_nh_a']; ADD

scan_path = [raw_path 'swerim_33_51_oh_a']; ADD

tomo.vol_size = [-0.45 0.2 -0.3 0.35 -0.49 0.49];
scan_path = [raw_path 'swerim_34_51_m_a']; ADD

scan_path = [raw_path 'swerim_35_51_nh_a']; ADD

scan_path = [raw_path 'swerim_36_af_band_a']; ADD
