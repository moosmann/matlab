function [phase,int,lo,nlo,ldp,phialpha]=LenaSchwingCTF(PhotonCountsForAddingNoise,compute_correction,blurring,sorder_smaxfac)
...
phi = RecoCTF(int,[sorder floor(smaxfac*resolution)],lambda,distance,pixelsize,paddingReco,padvalue,compute_correction);
lo  = phi(:,:,1);
nlo = phi(:,:,2);
