function synchroload2017nov03_11003773( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 27-Jun-2019 by moosmanj
...
tomo.rot_axis_offset = [];% -230.2;[]; % rotation axis offset w.r.t to the image center. Assuming the rotation axis position to be centered in the FOV for standard scan, the offset should be close to zero.
...
write.beamtimeID = '11003773'; % string (regexp),typically beamtime ID, mandatory if 'write.deleteFiles' is true (safety check)
...
par.window_state = 'minimized';

SET_DEFAULT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p05/2017/data/11003773/raw/';
...
% STRONG MOVEMENT ARTEFACTS, sample changed, some empty refs
raw_bin = 3;
tomo.rot_axis_offset = 1 * 3 / raw_bin;
scan_path = [raw_path 'syn100_53L_Mg5Gd_4w']; ADD

raw_bin = 2;
tomo.rot_axis_offset = 1 * 2 / raw_bin;
write.scan_name_appendix = '_Mg5Gd_4w';
scan_path = [raw_path 'syn101_53L']; ADD

%% PEEK
write.scan_name_appendix = '_PEEK_8w';
tomo.rot_axis_offset = 0.5 * 2 / raw_bin;
scan_path = [raw_path 'syn102_37L']; ADD

% missing projections
%scan_path = [raw_path 'syn103_35L']; ADD

%% Mg
tomo.rot_axis_offset = 2 * 2 / raw_bin;
write.scan_name_appendix = '_Mg10Gd_4w';
scan_path = [raw_path 'syn104_91L']; ADD

tomo.rot_axis_offset = 1.5 * 2 / raw_bin;
write.scan_name_appendix = '_Mg10Gd_4w';
scan_path = [raw_path 'syn105_100AR']; ADD

tomo.rot_axis_offset = 1.5 * 2 / raw_bin;
write.scan_name_appendix = '_Mg10Gd_12w';
scan_path = [raw_path 'syn106_70R']; ADD

tomo.rot_axis_offset = 1.5 * 2 / raw_bin;
write.scan_name_appendix = '_Mg10Gd_12w';
scan_path = [raw_path 'syn107_66R']; ADD

%% PEEK
tomo.rot_axis_offset = 1.5 * 2 / raw_bin;
write.scan_name_appendix = '_PEEK_8w';
scan_path = [raw_path 'syn108_25R']; ADD

%% Mg
tomo.rot_axis_offset = 2 * 2 / raw_bin;
write.scan_name_appendix = '_Mg10Gd_12w';
scan_path = [raw_path 'syn109_68R']; ADD
write.scan_name_appendix = '';

%empty scans
%scan_path = [raw_path 'syn110_22L_Ti_8w']; ADD

%% Ti
% CCD
tomo.rot_axis_offset = -6 * 3 / raw_bin;
scan_path = [raw_path 'syn111_22L_Ti_8w']; ADD
raw_bin = 3;
% CMOS
tomo.rot_axis_offset = 1 * 3 / raw_bin;
scan_path = [raw_path 'syn113_42L_Ti_12w']; ADD
tomo.rot_axis_offset = 0.35 * 3 / raw_bin;
scan_path = [raw_path 'syn114_34R_Ti_8w']; ADD
% CCD
raw_bin = 2;
tomo.rot_axis_offset = 0.5 * 2 / raw_bin;
scan_path = [raw_path 'syn115_34R_Ti_8w']; ADD
tomo.rot_axis_offset = 1.0 * 2 / raw_bin;
scan_path = [raw_path 'syn116_39R_Ti_12w']; ADD
tomo.rot_axis_offset = .75 * 2 / raw_bin;
scan_path = [raw_path 'syn117_31R_Ti_8w']; ADD
tomo.rot_axis_offset = 1.0 * 2 / raw_bin;
scan_path = [raw_path 'syn118_45L_Ti_12w']; ADD
tomo.rot_axis_offset = 1.5 * 2 / raw_bin;
scan_path = [raw_path 'syn119_9L_Ti_4w']; ADD
tomo.rot_axis_offset = 1.5 * 2 / raw_bin;
scan_path = [raw_path 'syn120_1L_Ti_4w']; ADD
tomo.rot_axis_offset = 0.5 * 2 / raw_bin;
scan_path = [raw_path 'syn121_7L_Ti_4w']; ADD
tomo.rot_axis_offset = 0.5 * 2 / raw_bin;
scan_path = [raw_path 'syn122_4R_Ti_4w']; ADD
tomo.rot_axis_offset = 0.5 * 2 / raw_bin;
scan_path = [raw_path 'syn123_10L_Ti_4w']; ADD
tomo.rot_axis_offset = 0.5 * 2 / raw_bin;
scan_path = [raw_path 'syn124_11L_Ti_4w']; ADD

scan_path = [raw_path 'syn125_cor_mg5gd410s_mg10gd401s_pmg1p_12']; ADD
scan_path = [raw_path 'syn126_cor_mg5gd414s_mg10gd405s_pmg2p_12']; ADD
scan_path = [raw_path 'syn127_cor_mg5gd430s_mg10gd413s_pmg9p_12']; ADD
scan_path = [raw_path 'syn128_cor_mg5gd432s_mg10gd418s_pmg10p_12']; ADD
scan_path = [raw_path 'syn129_cor_mg5gd413s_mg10gd409s_mg5gd3p_12']; ADD
scan_path = [raw_path 'syn130_cor_mg5gd416s_mg10gd410s_mg5gd7p_12']; ADD
scan_path = [raw_path 'syn131_cor_mg5gd428s_mg10gd407s_mg5gd8p_12']; ADD
scan_path = [raw_path 'syn132_cor_mg5gd434s_mg10gd408s_12']; ADD
scan_path = [raw_path 'syn133_cor_mg5gd1p_12']; ADD
