...
energy = 53500; % in eV! if empty: read from log file
...
phase_retrieval.reg_par = 1.75; % regularization parameter. larger values tend to blurrier images. smaller values tend to original data.
...
%% Phase retrieval
% 2n pitch 2.1076 is about 53.5 keV

phase_retrieval.apply = 1; 
phase_retrieval.method = 'tie';
phase_retrieval.reg_par = 1.75;
