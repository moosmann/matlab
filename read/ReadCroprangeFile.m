function [out c] = ReadCroprangeFile(PathToCroprangeFile)
...
%% Default arguments.
if nargin < 1
    PathToCroprangeFile = '/mnt/tomoraid-LSDF/tomo/APS_2BM_LifeCellImaging_GUP28266/lifecellimaging/int/wildtype_30keV_10min_deadtime_25tomo_stage11p0_upwards_620mm_015ms';
end
if nargin < 2
...
if exist(FilePath,'file')
    ...
    % horizontal  13      852     0
    % vertical    163     852     0
    c = textscan(fid,'dir\\pixel first last offset\nhorizontal %u %u %u\nvertical %u %u %u\n');
    % Close file.
    fclose(fid);
    % HorFirst  = c{1};
    % HorLast   = c{2};
