function [out NormOfSolution NormOfResidualOfSolution] = Lcurve(int,AlphaIntervall,NumOfPts,EnergyDistancePixelsize,doLogOfNorm,Padding_FactorAndValue)
