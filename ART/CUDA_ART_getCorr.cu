...
// in proj is already raySum/rayWeight kept!

__global__ void proj(const float * R, const int * volSize, const int * projSize, float * vol, const float * recOrig, const float * origProj, const float * proj, const int * gridTrace ) {
