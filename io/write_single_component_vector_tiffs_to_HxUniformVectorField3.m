function write_single_component_vector_tiffs_to_HxUniformVectorField3( input_folder, steps_pattern, vector_pattern, out_path, out_name, steps_to_process )
...
for nn = 1:numel( steps_to_process )
    ...
    dtype = class( vec );
    write_HxUniformVectorField3( filename, vec, dtype, [], 0 )
