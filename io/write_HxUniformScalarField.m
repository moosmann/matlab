function write_HxUniformScalarField( filename, array, dtype, bounding_box, verbose )
% Write 3D volumetric vector field to Amira/Avizo compliant
% HxUniformVectorField3.
%
% ARGUMENTS
% filename : string. Output filename.
% array : 3D scalar array
...
if nargin < 1
    filename = '/asap3/petra3/gpfs/p05/2017/data/11003950/processed/syn13_55L_Mg10Gd_12w_load/dvc/HxUniformScalarField/div.am';
end
if nargin < 2
    array = ones( [100 101 102], 'single' );
end
if nargin < 3
    dtype = '';
end
...
PrintVerbose( verbose, '\nWrite 3D scalar array to Avizo/Amira-compliant HxUniformScalarField' )
...
am_header = sprintf( [ ...
    ...
    newline...
    sprintf('Parameters {\n')...
    sprintf( '    Content "%ux%ux%u float, uniform coordinates",\n', shape)...
    sprintf( '    BoundingBox %u %u %u %u %u %u,\n', bounding_box)...
    sprintf( '    CoordType "uniform"\n' )...
    sprintf('}\n')...
    newline...
    sprintf('Lattice { float Data } @1\n')...
    newline...
