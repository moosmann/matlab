...
raw_path = '/asap3/petra3/gpfs/p05/2018/data/11004223/raw';
...
%scan_name ='mpikg_002_urha29l';
scan_name = 'sar_25';

savedir=['/asap3/petra3/gpfs/p05/2018/data/11004223/processed/' scan_name];
CheckAndMakePath(savedir)
...
for nn = 1:nn_max
    ...
    if exist( filename, 'file')
        ...
        csvfilename=[savedir filesep struct_scans(nn).name '_waiting.csv'];
        cHeader = {'time' 'force' 'pusher'}; %dummy header
    ...
    if exist( filename, 'file')
            ...
            csvfilename=[savedir filesep struct_scans(nn).name '_tomo.csv'];
            ...
            datvalues(:,1)=(timet-timet(1)) / 3600 / 1e3;
            datvalues(:,2)=forcet;
