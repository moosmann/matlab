function [m0,m1,m0r,m1r] = SpectralAnlaysis2(phase_exact, ...
                                                      phase_rec_0,phase_rec_1,phase_rec_2)
    
    
    phe_f = normat(fft2((phase_exact)));
    ph0_f = normat(fft2((phase_rec_0)));
    ph1_f = normat(fft2((phase_rec_0 + phase_rec_1 + phase_rec_2)));
    ranges(phe_f)
    ranges(ph0_f)
    ranges(ph1_f)
