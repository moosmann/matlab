...
fprintf( '\nrevolution time: %.3f µs', rev_time * 1e6 )
fprintf( '\nrevolution frequency: %.1f kHz', rev_freq/1000 )
fprintf( '\nrevolution frequency at light speed: %.3f ', rev_time_c * 1e6 )
...
fprintf( '\nnumber of electrons: %10.2g', num_electrons_from_beam_charge )
...
fprintf( '%10.0f', bunch_separation * 1e9 )

fprintf( '\n%30s: ', 'revolution time / #bunches' )
fprintf( '%10.0f', rev_time * 1e9 ./ num_bunches )
