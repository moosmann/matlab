...
% Created on 02-Jun-2021 by moosmanj
...
tomo.rot_axis_offset = 0.0 * 4 / par.raw_bin;

par.scan_path = [raw_path '0018_camtest_o-060_pga001_adc040']; ADD
par.scan_path = [raw_path '0019_camtest_o-030_pga001_adc040']; ADD

% tomo.rot_axis_offset = -1.5 * 4 / par.raw_bin;
% write.subfolder_reco = sprintf( 'rao%06.2f', tomo.rot_axis_offset); ADD
% 
% tomo.rot_axis_offset = -1 * 4 / par.raw_bin;
% write.subfolder_reco = sprintf( 'rao%06.2f', tomo.rot_axis_offset); ADD
% 
% tomo.rot_axis_offset = -0.5 * 4 / par.raw_bin;
% write.subfolder_reco = sprintf( 'rao%06.2f', tomo.rot_axis_offset); ADD
% 
% tomo.rot_axis_offset = 0 * 4 / par.raw_bin;
% write.subfolder_reco = sprintf( 'rao%06.2f', tomo.rot_axis_offset); ADD
% 
% tomo.rot_axis_offset = 0.5 * 4 / par.raw_bin;
% write.subfolder_reco = sprintf( 'rao%06.2f', tomo.rot_axis_offset); ADD
...
par.scan_path = [raw_path '0019_camtest_o-030_pga001_adc040']; ADD
par.scan_path = [raw_path '0020_camtest_o0000_pga001_adc040']; ADD
par.scan_path = [raw_path '0021_camtest_o-060_pga001_adc050']; ADD
par.scan_path = [raw_path '0022_camtest_o-030_pga001_adc050']; ADD
par.scan_path = [raw_path '0023_camtest_o0000_pga001_adc050']; ADD
par.scan_path = [raw_path '0024_camtest_o-100_pga001_adc055']; ADD
par.scan_path = [raw_path '0025_camtest_o-060_pga001_adc055']; ADD
par.scan_path = [raw_path '0026_camtest_o0000_pga001_adc055']; ADD
par.scan_path = [raw_path '0027_camtest_o-350_pga001_adc060']; ADD
par.scan_path = [raw_path '0028_camtest_o-175_pga001_adc060']; ADD
par.scan_path = [raw_path '0029_camtest_o-100_pga001_adc060']; ADD
par.scan_path = [raw_path '0030_camtest_o-060_pga001_adc060']; ADD
par.scan_path = [raw_path '0031_camtest_o0000_pga001_adc060']; ADD

tomo.rot_axis_offset = -1.25 * 4 / par.raw_bin;

tomo.rot_axis_tilt_camera = 0; 
write.subfolder_reco = 'tilt0p000';
par.scan_path = [raw_path '0002_test']; ADD

write.subfolder_reco = 'tilt0p004';
tomo.rot_axis_tilt_camera = 0.004; 
par.scan_path = [raw_path '0002_test']; ADD


par.scan_path = [raw_path '0010_test'];

tomo.rot_axis_tilt_camera = -0.004; 
write.subfolder_reco = 'tilt-0p004';
ADD
