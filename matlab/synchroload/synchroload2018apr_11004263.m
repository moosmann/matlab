...
par.scan_path = [raw_path 'syn003_70L_Mg5Gd_12w_test_fli']; ADD

% No ring current normalization due to false names in hdf5 file
par.raw_roi = -1;
tomo.rot_axis.offset = 1.5 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn004_96R_Mg5Gd_8w_a']; ADD
par.scan_path = [raw_path 'syn004_96R_Mg5Gd_8w_b']; ADD

tomo.rot_axis.offset = 0.5 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn005_90L_Mg10Gd_4w_a']; ADD
tomo.rot_axis.offset = 0.75 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn005_90L_Mg10Gd_4w_b']; ADD

tomo.rot_axis.offset = 0.25 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn006_101BR_Mg10Gd_4w_a']; ADD
tomo.rot_axis.offset = 0.3 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn006_101BR_Mg10Gd_4w_b']; ADD

tomo.rot_axis.offset = -0.125 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn007_76L_Mg5Gd_8w_a']; ADD
tomo.rot_axis.offset = -0.125 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn007_76L_Mg5Gd_8w_b']; ADD

tomo.rot_axis.offset = 0.125 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn008_93R_Mg5Gd_8w_a']; ADD
tomo.rot_axis.offset = 0.25 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn008_93R_Mg5Gd_8w_b']; ADD

tomo.rot_axis.offset = 0.75 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn009_64L_Mg5Gd_12w_a']; ADD
tomo.rot_axis.offset = 0.85 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn009_64L_Mg5Gd_12w_b']; ADD

tomo.rot_axis.offset = -0.15 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn010_78R_Mg10Gd_8w_a']; ADD
tomo.rot_axis.offset = -0.05 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn010_78R_Mg10Gd_8w_b']; ADD

tomo.rot_axis.offset = 0.65 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn011_90R_Mg5Gd_4w_a']; ADD
tomo.rot_axis.offset = 0.65 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn011_90R_Mg5Gd_4w_b']; ADD

tomo.rot_axis.offset = 0.1 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn012_93L_Mg10Gd_8w_a']; ADD
tomo.rot_axis.offset = 0.2 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn012_93L_Mg10Gd_8w_b']; ADD

tomo.rot_axis.offset = -0.7 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn013_45R_PEEK_12w_a']; ADD
par.scan_path = [raw_path 'syn013_45R_PEEK_12w_b']; ADD

tomo.rot_axis.offset = -1.1 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn014_85R_Mg5Gd_4w_a']; ADD
par.scan_path = [raw_path 'syn014_85R_Mg5Gd_4w_b']; ADD

% Medium quality, probably movement
tomo.rot_axis.offset = -1.0 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn015_97L_Mg5Gd_4w_a']; ADD
tomo.rot_axis.offset = -1.3 * 2 /  par.raw_bin; 
par.scan_path = [raw_path 'syn015_97L_Mg5Gd_4w_b']; ADD

tomo.rot_axis.offset = 0.2 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn016_26R_PEEK_8w_a']; ADD
par.scan_path = [raw_path 'syn016_26R_PEEK_8w_b']; ADD

tomo.rot_axis.offset = 0.25 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn017_41R_PEEK_12w_a']; ADD
par.scan_path = [raw_path 'syn017_41R_PEEK_12w_b']; ADD

tomo.rot_axis.offset = -0.3 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn018_35L_PEEK_8w_a']; ADD
tomo.rot_axis.offset = -0.8 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn018_35L_PEEK_8w_b']; ADD
%% TODO
par.scan_path = [raw_path 'syn018_35L_PEEK_8w_c']; ADD

% Very good quality
tomo.rot_axis.offset = 0.15 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn019_77R_Mg10Gd_8w_a']; ADD
tomo.rot_axis.offset = 0.15 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn019_77R_Mg10Gd_8w_b']; ADD

tomo.rot_axis.offset = -0.2 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn020_61L_PEEK_12w_a']; ADD
par.scan_path = [raw_path 'syn020_61L_PEEK_12w_b']; ADD

% good quality
tomo.rot_axis.offset = -1.2 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn021_70R_Mg10Gd_12w_a']; ADD
tomo.rot_axis.offset = -1.2 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn021_70R_Mg10Gd_12w_b']; ADD

tomo.rot_axis.offset = -1.6 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn022_91R_Mg5Gd_4w_a']; ADD
tomo.rot_axis.offset = -1.6 * 2 /  par.raw_bin; % Check taken from recolog
par.scan_path = [raw_path 'syn022_91R_Mg5Gd_4w_b']; ADD

% average quality
tomo.rot_axis.offset = -1.9 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn023_72L_Mg5Gd_12w_a']; ADD
tomo.rot_axis.offset = -2.1 * 2 /  par.raw_bin;
par.scan_path = [raw_path 'syn023_72L_Mg5Gd_12w_b']; ADD

%% CMOS
par.raw_bin = 3;
% par.scan_path = [raw_path 'syn024_72L_Mg5Gd_12w_kit']; ADD
% par.scan_path = [raw_path 'syn025_72L_Mg5Gd_12w_kit']; ADD
% par.scan_path = [raw_path 'syn026_72L_Mg5Gd_12w_kit']; ADD
% par.scan_path = [raw_path 'syn027_72L_Mg5Gd_12w_kit']; ADD
% par.scan_path = [raw_path 'syn028_72L_Mg5Gd_12w_kit']; ADD
% par.scan_path = [raw_path 'syn029_72L_Mg5Gd_12w_kit']; ADD
par.raw_bin = 4;
bin_before_filtering(1) = 1;
interactive_mode.rot_axis_pos = 1;
par.scan_path = [raw_path 'syn030_72L_Mg5Gd_12w_kit_noshake']; ADD
par.scan_path = [raw_path 'syn031_72L_Mg5Gd_12w_kit_noshake_reallyNoShake']; ADD
par.scan_path = [raw_path 'syn032_72L_Mg5Gd_12w_kit']; ADD

par.raw_bin = 3;
%% Check
% Not working. offset shift problems, probably due to missing images
tomo.rot_axis.offset = 0.7 * 3 /  par.raw_bin;
par.scan_path = [raw_path 'syn033_70L_Mg5Gd_12w_a']; ADD
% Good
tomo.rot_axis.offset = 0.7 * 3 /  par.raw_bin;
par.scan_path = [raw_path 'syn033_70L_Mg5Gd_12w_b']; ADD

% Good quality
tomo.rot_axis.offset = -0.3 * 3 /  par.raw_bin;
par.scan_path = [raw_path 'syn034_74L_Mg5Gd_8w_a']; ADD
tomo.rot_axis.offset = -0.4 * 3 /  par.raw_bin;
par.scan_path = [raw_path 'syn034_74L_Mg5Gd_8w_b']; ADD

% Good quality, local movement
tomo.rot_axis.offset = - 1.3 * 3 /  par.raw_bin;
par.scan_path = [raw_path 'syn035_77L_Mg5Gd_8w_a']; ADD
tomo.rot_axis.offset = - 1.3 * 3 /  par.raw_bin;
par.scan_path = [raw_path 'syn035_77L_Mg5Gd_8w_b']; ADD

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%interactive_mode.rot_axis_pos = 0;
par.raw_bin = 4; 
tomo.rot_axis.offset = 1.0 * 4 /  par.raw_bin; 
par.scan_path = [raw_path 'syn036_cor_mg5gd410s_mg10gd401s_pmg1p_30_a']; ADD
par.scan_path = [raw_path 'syn036_cor_mg5gd410s_mg10gd401s_pmg1p_30_b']; ADD
par.scan_path = [raw_path 'syn036_cor_mg5gd410s_mg10gd401s_pmg1p_30_c']; ADD

tomo.rot_axis.offset = -0.4 * 4 /  par.raw_bin; 
par.scan_path = [raw_path 'syn037_cor_mg5gd414s_mg10gd405s_pmg2p_30_a']; ADD
par.scan_path = [raw_path 'syn037_cor_mg5gd414s_mg10gd405s_pmg2p_30_b']; ADD
% tomo.rot_axis.offset = -0.5 * 4 /  par.raw_bin; visually rather 0.5, measure
% peaks about -0.25
par.scan_path = [raw_path 'syn037_cor_mg5gd414s_mg10gd405s_pmg2p_30_c']; ADD

tomo.rot_axis.offset = -0.55 * 4 /  par.raw_bin; 
par.scan_path = [raw_path 'syn038_cor_mg5gd430s_mg10gd413s_pmg9p_30_a']; ADD
par.scan_path = [raw_path 'syn038_cor_mg5gd430s_mg10gd413s_pmg9p_30_b']; ADD
par.scan_path = [raw_path 'syn038_cor_mg5gd430s_mg10gd413s_pmg9p_30_c']; ADD

% only 1502 projections
par.scan_path = [raw_path 'syn039_cor_mg5gd432s_mg10gd418s_pmg10p_30_a']; ADD
par.scan_path = [raw_path 'syn039_cor_mg5gd432s_mg10gd418s_pmg10p_30_b']; ADD
par.scan_path = [raw_path 'syn039_cor_mg5gd432s_mg10gd418s_pmg10p_30_c']; ADD

tomo.rot_axis.offset = -1.1 * 4 /  par.raw_bin; 
par.scan_path = [raw_path 'syn040_cor_mg5gd413s_mg10gd409s_mg5gd3p_30_a']; ADD
par.scan_path = [raw_path 'syn040_cor_mg5gd413s_mg10gd409s_mg5gd3p_30_b']; ADD
par.scan_path = [raw_path 'syn040_cor_mg5gd413s_mg10gd409s_mg5gd3p_30_c']; ADD

% par.scan_path = [raw_path 'syn041_cor_mg5gd416s_mg10gd410s_mg5gd7p_30_a']; ADD
