function p05_reco_loop_igg_milatz_11023208( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 24-Sep-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p05/2025/data/11023208/raw/';
par.raw_bin = 2; 
interactive_mode.rot_axis_pos = 1; 

par.scan_path = [raw_path 'igg001_silt_step']; ADD

par.scan_path = [raw_path 'igg002_fine_sand_step']; ADD

par.scan_path = [raw_path 'igg003_fine_sand_fly_p1000_100ms']; 
tomo.rot_axis_offset = 2 * [-1.6] / par.raw_bin;
phase_retrieval.apply = 1; % bool. See 'PhaseFilter' for detailed description of parameters !
ADD

par.scan_path = [raw_path 'igg004_fine_sand_fly_p1000_050ms']; ADD

par.scan_path = [raw_path 'igg005_fine_sand_fly_p1000_010ms']; ADD

par.scan_path = [raw_path 'igg005_fine_sand_fly_p1000_025ms']; ADD

par.scan_path = [raw_path 'igg007_fine_sand_fly_p1000_005ms']; ADD

par.scan_path = [raw_path 'igg008_fine_sand_fly_p1000_007ms']; ADD

par.scan_path = [raw_path 'igg009_fine_sand_fly_p0500_100ms']; ADD

par.scan_path = [raw_path 'igg010_fine_sand_fly_p0500_050ms']; ADD

par.scan_path = [raw_path 'igg011_fine_sand_fly_p0500_025ms']; ADD

par.scan_path = [raw_path 'igg012_fine_sand_fly_p0500_010ms']; ADD

par.scan_path = [raw_path 'igg013_silt_p1000_100ms']; ADD

par.scan_path = [raw_path 'igg014_silt_p1000_050ms']; ADD

par.scan_path = [raw_path 'igg015_silt_p1000_025ms']; ADD

par.scan_path = [raw_path 'igg016_silt_p1000_010ms']; ADD

par.scan_path = [raw_path 'igg017_silt_p0500_100ms']; ADD

par.scan_path = [raw_path 'igg018_silt_p0500_050ms']; ADD

par.scan_path = [raw_path 'igg019_silt_p0500_025ms']; ADD

par.scan_path = [raw_path 'igg020_silt_p0500_010ms']; ADD

par.scan_path = [raw_path 'igg021_silt_p0300_010ms']; ADD

par.scan_path = [raw_path 'igg022_silt_p0400_010ms']; ADD
