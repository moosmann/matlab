function p05_reco_loop_MBS_pins_11015385( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 21-Sep-2022 by moosmanj
...
image_correlation.area_width = [0.25 0.75];
image_correlation.area_height =[0.90 0.98];
% increase reco ROI for interactive mode (should be set automatically to
...
par.scan_path = [raw_path '0013_WB_ref_6p3_14d']; ADD

par.scan_path = [raw_path '0014_WB_peo_ag_5p3_14d']; ADD
