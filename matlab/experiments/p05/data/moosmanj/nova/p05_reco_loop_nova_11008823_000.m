function p05_reco_loop_nova_11008823_000( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 10-Jun-2020 by moosmanj
...
tomo.rot_angle_offset = pi; % global rotation of reconstructed volumevv
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p05/2020/data/11008823/raw/';

scan_path = [raw_path 'nova001_pentatomidae_a']; ADD

scan_path = [raw_path 'nova001_pentatomidae_b']; ADD

scan_path = [raw_path 'nova002_typhaeus_typhoeusa']; ADD

scan_path = [raw_path 'nova002_typhaeus_typhoeusc']; ADD

raw_roi = [0.4 0.6]; 
tomo.rot_axis_offset = 0;
scan_path = [raw_path 'nova003_pentatomidae_a']; 
pixel_scaling = 1.00; 
write.parfolder = regexprep( sprintf( 'pixScaling%.3f', pixel_scaling ), '\.', 'p' );ADD
pixel_scaling = 1.005;
write.parfolder = regexprep( sprintf( 'pixScaling%.3f', pixel_scaling ), '\.', 'p' );ADD
pixel_scaling = 1.006;
write.parfolder = regexprep( sprintf( 'pixScaling%.3f', pixel_scaling ), '\.', 'p' );ADD
...
scan_path = [raw_path 'nova003_pentatomidae_b']; ADD

scan_path = [raw_path 'nova004_pyrochroa_coccinea_a']; ADD
