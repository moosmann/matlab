function p05_reco_loop_hnee_11004450_000( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
% For dose estimation

% Created on 22-Apr-2021 by moosmanj
...
pixel_filter_threshold_dark = [0.03 0.02]; % Dark fields: threshold parameter for hot/dark pixel filter, for details see 'FilterPixel'
pixel_filter_threshold_flat = [0.03 0.02]; % Flat fields: threshold parameter for hot/dark pixel filter, for details see 'FilterPixel'
...
par.scan_path = [raw_path 'hnee01_kie_sh_ts_000N']; ADD

par.scan_path = [raw_path 'hnee02_kie_sh_ts_000N']; ADD

par.scan_path = [raw_path 'hnee03_kie_sh_ts_000N']; ADD

par.scan_path = [raw_path 'hnee04_kie_sh_ts_000N']; ADD

par.scan_path = [raw_path 'hnee05_kie_sh_ts_000N']; ADD

par.scan_path = [raw_path 'hnee06_kie_sh_ts_000N']; ADD

par.scan_path = [raw_path 'hnee07_kie_sh_ts_000N']; ADD

par.scan_path = [raw_path 'hnee08_kie_sh_ts_000']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_001']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_002']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_003']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_004']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_005']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_006']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_007']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_008']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_009']; ADD

par.scan_path = [raw_path 'hnee09_kie_sh_ts_010']; ADD

par.scan_path = [raw_path 'hnee10_kie_fh_ts_0p5N']; ADD

par.scan_path = [raw_path 'hnee11_kie_fh_ts_0p5N']; ADD

par.scan_path = [raw_path 'hnee12_kie_fh_ts_0p5N']; ADD

par.scan_path = [raw_path 'hnee13_kie_fh_ts_0p5N']; ADD

par.scan_path = [raw_path 'hnee14_kie_fh_ts_0p5N']; ADD

par.scan_path = [raw_path 'hnee15_kie_fh_ts_000']; ADD

par.scan_path = [raw_path 'hnee16_kie_fh_ts_000']; ADD

par.scan_path = [raw_path 'hnee17_kie_fh_ts_000']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_000']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_001']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_002']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_003']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_004']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_005']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_006']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_007']; ADD

par.scan_path = [raw_path 'hnee18_pappel_tensionWood_008']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_000']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_001']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_002']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_003']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_004']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_005']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_006']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_007']; ADD

par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_008']; ADD

par.scan_path = [raw_path 'hnee20_pappel_tensionWood_000']; ADD

par.scan_path = [raw_path 'hnee20_pappel_tensionWood_001']; ADD

par.scan_path = [raw_path 'hnee20_pappel_tensionWood_002']; ADD

par.scan_path = [raw_path 'hnee20_pappel_tensionWood_003']; ADD

par.scan_path = [raw_path 'hnee21_pappel_oppositeWood_000']; ADD

par.scan_path = [raw_path 'hnee21_pappel_oppositeWood_001']; ADD

par.scan_path = [raw_path 'hnee21_pappel_oppositeWood_002']; ADD

par.scan_path = [raw_path 'hnee21_pappel_oppositeWood_003']; ADD

par.scan_path = [raw_path 'hnee21_pappel_oppositeWood_004']; ADD

par.scan_path = [raw_path 'hnee21_pappel_oppositeWood_005']; ADD

par.scan_path = [raw_path 'hnee21_pappel_oppositeWood_006']; ADD

par.scan_path = [raw_path 'hnee22_pappel_oppositeWood_000']; ADD

par.scan_path = [raw_path 'hnee22_pappel_oppositeWood_001']; ADD

par.scan_path = [raw_path 'hnee22_pappel_oppositeWood_002']; ADD

par.scan_path = [raw_path 'hnee22_pappel_oppositeWood_003']; ADD

par.scan_path = [raw_path 'hnee22_pappel_oppositeWood_004']; ADD

par.scan_path = [raw_path 'hnee22_pappel_oppositeWood_005']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_000']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_001']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_002']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_003']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_004']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_005']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_006']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_007']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_008']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_009']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_010']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_011']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_012']; ADD

par.scan_path = [raw_path 'hnee23_pappel_tensionWood_013']; ADD
