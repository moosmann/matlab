function p05_reco_loop_hnee_11004450_dose( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
% For dose estimation
...
par.raw_roi = [1100 2500]; % vertical and/or horizontal ROI; (1,1) coordinate = top left pixel; supports absolute, relative, negative, and mixed indexing.
% []: use full image;
...
pixel_filter_radius = [15 15]; % Increase only if blobs of zeros or other artefacts are expected. Can increase processing time heavily.
...
tomo.rot_axis.offset = 2 * -10.6 / par.raw_bin;
par.scan_path = [raw_path 'hnee19_pappel_oppositeWood_005']; ADD
tomo.rot_axis.offset = 2 * -10.7 / par.raw_bin;
