function p05_reco_loop_hub_batteries_11018827( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 12-May-2025 by moosmanj
...
par.scan_path = [raw_path '0001_CuS_FeS_fly_d80_m05_e35000']; ADD

par.scan_path = [raw_path '0002_LCL5N_7_step_d80_m05_e35000']; ADD

par.scan_path = [raw_path '0003_CuFeS2_0p5Npm_50thdis']; ADD

par.scan_path = [raw_path '0004_CuFeS2_0p5Npm_50thdis']; ADD

par.scan_path = [raw_path '0006_Cu2S_ocv']; ADD

par.scan_path = [raw_path '0007_LClpre5N_7_prin']; ADD

par.scan_path = [raw_path '0008_LClpre5N_7_prin']; ADD

par.scan_path = [raw_path '0009_Cu2S_ocv']; ADD

par.scan_path = [raw_path '0010_Cu2S_ocv']; ADD

par.scan_path = [raw_path '0011_B_cell9_FeS2_-0p1_ocv']; ADD

par.scan_path = [raw_path '0012_LClpre2N_8_prin']; ADD

par.scan_path = [raw_path '0013_LClpre2N_8_prin']; ADD

par.scan_path = [raw_path '0014_LClpre2N_8_prin']; ADD

par.scan_path = [raw_path '0015_Lpre5N_9_prin']; ADD

par.scan_path = [raw_path '0016_Lpre2N_10_prin']; ADD

par.scan_path = [raw_path '0017_L2N_10_prin']; ADD
...
par.scan_path = [raw_path '0024_Cell1_CuFeS2_1stdis_0p9V']; ADD

par.scan_path = [raw_path '0025_Cell2_CuS_FeS_1stdis_0p9V']; ADD

par.scan_path = [raw_path '0026_Cell7_Cu2S_1stdis_1p2V']; ADD

par.scan_path = [raw_path '0027_Cell6_CuS_FeS_50thdis_0p5Nm_0p08V']; ADD

par.scan_path = [raw_path '0028_Cell3_CuFeS2_50thdis_2p5Nm_0p08V']; ADD

par.scan_path = [raw_path '0029_Cell4_CuS-FeS_50thdis_2p5Nm_0p08V']; ADD

par.scan_path = [raw_path '0030_Cell4_CuS-FeS_50thdis_2p5Nm_0p08V']; ADD

par.scan_path = [raw_path '0031_Cell8_FeS2_0p6_1stdis0p8V']; ADD
...
par.scan_path = [raw_path '0037_LClPre2N_8_2dis']; ADD

par.scan_path = [raw_path '0039_LClPre2N_8_2dis_repeat2']; ADD

par.scan_path = [raw_path '0040_LPre5N_9_1char2.0']; ADD

par.scan_path = [raw_path '0041_LPre2N_10_1char2.0']; ADD

par.scan_path = [raw_path '0042_L2N_10_1dis4mah']; ADD

par.scan_path = [raw_path '0043_L5N_12_1dis4mah']; ADD

par.scan_path = [raw_path '0044_Lpre5N_9_3dis']; ADD

par.scan_path = [raw_path '0045_LClpre2N_8_4char2']; ADD

par.scan_path = [raw_path '0046_L5N_12_4dis1h']; ADD

par.scan_path = [raw_path '0047_Lclpre5N_7_4char']; ADD

par.scan_path = [raw_path '0048_L2N_11_4char']; ADD

par.scan_path = [raw_path '0049_Lpre2N_10_4dis']; ADD

par.scan_path = [raw_path '0050_Cell1_CUFeS2_1stdis0p08V']; ADD

par.scan_path = [raw_path '0051_Cell2_CUS_FeS_1stdis0p08V']; ADD

par.scan_path = [raw_path '0052_Cell9_FeS2_0p1_1stdis0p6V']; ADD

par.scan_path = [raw_path '0053_Cell8_FeS2_0p6_1stdis0p6V']; ADD

par.scan_path = [raw_path '0054_Cell3_CuFeS2_2p5Nm_50thCh2p38V']; ADD

par.scan_path = [raw_path '0055_Cell4_CuS-FeS_2p5Nm_50thCh2p38V']; ADD

par.scan_path = [raw_path '0056_Cell1_CuFeS2_2p5Nm_1stCh1p15V']; ADD

par.scan_path = [raw_path '0057_Cell7_Cu2S_2p5Nm_1stdis0p08V']; ADD

par.scan_path = [raw_path '0058_Cell2_CuS_FeS_2p5Nm_1stch1p15V']; ADD

par.scan_path = [raw_path '0059_Cell8_FeS2_2p5Nm_1stch1p1V']; ADD

par.scan_path = [raw_path '0060_Cell4_CuS_FeS_2p5Nm_51th_dis0p9V']; ADD

par.scan_path = [raw_path '0061_Cell3_CuFeS2_2p5Nm_51th_dis0p9V']; ADD

par.scan_path = [raw_path '0062_Cell9_FeS2_0p1_1stdis0p1V']; ADD

par.scan_path = [raw_path '0063_Cell1_CuFeS2_2pNm_1stch1p3V']; ADD

par.scan_path = [raw_path '0064_Cell7_Cu2S_2pNm_1stch1p1V']; ADD

par.scan_path = [raw_path '0065_Cell2_CuS_FeS_2p5Nm_1stch1p3V']; ADD

par.scan_path = [raw_path '0066_Cell4_CuS_FeS_2p5Nm_51stdis0p5V']; ADD

par.scan_path = [raw_path '0067_Cell9_FeS2_0p1_1stch1p1V']; ADD

par.scan_path = [raw_path '0068_Cell3_CuFeS2_2p5Nm_51stdis0p5V']; ADD

par.scan_path = [raw_path '0069_Cell8_FeS2_0p6Nm_1stch1p3V']; ADD

par.scan_path = [raw_path '0070_Cell6_CuS_FeS_0p5Nm_50thch2p38V']; ADD

par.scan_path = [raw_path '0071_Cell2_CuS_FeS_2p5Nm_1stch1p6V']; ADD

par.scan_path = [raw_path '0072_Cell1_CuFeS2_2p5Nm_1stch1p6V']; ADD

par.scan_path = [raw_path '0073_Cell8_FeS2_2p5Nm_1stch1p8V']; ADD

par.scan_path = [raw_path '0074_Cell3_CuFeS2_2p5Nm_51th_ch1p15V']; ADD

par.scan_path = [raw_path '0075_Cell9_FeS2_2p5Nm_1stch1p3V']; ADD

par.scan_path = [raw_path '0076_cell4_CuS_FeS_2pNm_51th_ch1p15V']; ADD

par.scan_path = [raw_path '0077_cell9_FeS2_2pNm_1stch1p8V']; ADD

par.scan_path = [raw_path '0078_cell1_CuFeS2_2pNm_1stch2p38V']; ADD

par.scan_path = [raw_path '0079_cell4_CuS_FeS_2p5Nm_51th_ch1p3V']; ADD

par.scan_path = [raw_path '0080_cell3_CuFeS2_2p5Nm_51th_ch1p3V']; ADD

par.scan_path = [raw_path '0081_cell2_CuS_FeS_2p5Nm_1st_ch2p38V']; ADD

par.scan_path = [raw_path '0082_cell7_Cu2S_2p5Nm_1st_ch2p38V']; ADD

par.scan_path = [raw_path '0083_CuFeS2_2p5Nm_51th_ch1p6V']; ADD

par.scan_path = [raw_path '0084_CuS_FeS_2p5Nm_31th_ch1p6V']; ADD

par.scan_path = [raw_path '0085_CuS_FeS_2p5Nm_31th_ch1p6V']; ADD

par.scan_path = [raw_path '0086_Cell8_FES2_op6_1st_ch2p38v']; ADD

par.scan_path = [raw_path '0087_cell9_FeS2_0p1_1st_ch2p38V']; ADD

par.scan_path = [raw_path '0088_CuFeS2_2p5Nm_51th_ch1p6V']; ADD
