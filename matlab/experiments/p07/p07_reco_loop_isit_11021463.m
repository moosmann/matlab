function p07_reco_loop_isit_11021463( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 22-May-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11021463/raw/';
...
par.stitch_method =  'step';'linear'; 'sine';

tomo.rot_axis_offset = 5 * 552.3 / par.raw_bin;
par.scan_path = [raw_path 'isit001_3_1']; ADD

tomo.rot_axis_offset = 5 * 552.4 / par.raw_bin;
par.scan_path = [raw_path 'isit001_3_1_b']; ADD

tomo.rot_axis_offset = 5 * 552 / par.raw_bin;
par.scan_path = [raw_path 'isit002_4_1_a']; ADD

tomo.rot_axis_offset = 5 * 553.5 / par.raw_bin;
par.scan_path = [raw_path 'isit002_4_1_b']; ADD

tomo.rot_axis_offset = 5 * 551.5 / par.raw_bin;
par.scan_path = [raw_path 'isit003_1_1_a']; ADD

tomo.rot_axis_offset = 5 * 551.5 / par.raw_bin;
par.scan_path = [raw_path 'isit003_1_1_b']; ADD

tomo.rot_axis_offset = 5 * 553.5 / par.raw_bin;
par.scan_path = [raw_path 'isit004_1_2_a']; ADD

tomo.rot_axis_offset = 5 * 552.9 / par.raw_bin;
par.scan_path = [raw_path 'isit004_1_2_b']; ADD

tomo.rot_axis_offset = 5 * 552.8 / par.raw_bin;
par.scan_path = [raw_path 'isit005_3_2_a']; ADD

% sample probably moved
tomo.rot_axis_offset = 5 * 553.0 / par.raw_bin;
par.scan_path = [raw_path 'isit005_3_2_b']; ADD

tomo.rot_axis_offset = 5 * 553.5 / par.raw_bin;
par.scan_path = [raw_path 'isit006_4_2_a']; ADD

tomo.rot_axis_offset = 5 * 553.0 / par.raw_bin;
par.scan_path = [raw_path 'isit006_4_2_b']; ADD

tomo.rot_axis_offset = 5 * 552.0 / par.raw_bin;
par.scan_path = [raw_path 'isit006_4_2_c']; ADD

% beam dump, missing data
%par.scan_path = [raw_path 'isit007_5_1_a']; ADD

tomo.rot_axis_offset = 5 * 551.9 / par.raw_bin;
par.scan_path = [raw_path 'isit007_5_1_b']; ADD

tomo.rot_axis_offset = 5 * 0 / par.raw_bin;
tomo.vol_size = [-0.6 0.6 -0.6 0.6 -0.5 0.5];
par.scan_path = [raw_path 'isit008_5_2_a']; ADD

tomo.vol_size = [-1 1 -1 1 -0.5 0.5];
tomo.rot_axis_offset = 5 * 552.3 / par.raw_bin;
par.scan_path = [raw_path 'isit009_6_1_a']; ADD

tomo.rot_axis_offset = 5 * 552.9 / par.raw_bin;
par.scan_path = [raw_path 'isit010_6_2_a']; ADD

%incomplete or missing data
%par.scan_path = [raw_path 'isit011_6_2_a']; ADD
%par.scan_path = [raw_path 'isit011_6_2_b']; ADD
%par.scan_path = [raw_path 'isit011_6_2_c']; ADD

% Wackel Scan, Apertur im Bild
% Artefakte in der Reko, aber nicht durch Apertur
par.stitch_projections = 0;
tomo.rot_axis_offset = 5 * 1 / par.raw_bin;
par.scan_path = [raw_path 'isit011_6_2_d']; ADD

par.scan_path = '/home/moosmanj/p07/2025/data/11021468/raw/test001';
