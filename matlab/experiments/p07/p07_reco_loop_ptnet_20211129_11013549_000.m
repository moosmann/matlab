function p07_reco_loop_ptnet_20211129_11013549_000( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 01-Dec-2021 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2021/data/11013549/raw/';

interactive_mode.rot_axis_pos = 0; % reconstruct slices with dif+ferent rotation axis offsets
tomo.rot_axis_search_auto = 1; 
tomo.rot_axis_search_range = -6.5:0.1:-4;
tomo.rot_axis_search_metric = 'neg'; 
tomo.rot_axis_search_extrema = 'max';
tomo.rot_axis_search_fit = 0; 

%hereon01_ptnet01_c: tomo.rot_axis_offset at 2 x binning : -5.800000
par.scan_path = [raw_path 'hereon01_ptnet01_c']; ADD

% hereon02_ptnet02_c: tomo.rot_axis_offset at 2 x binning : -4.900000
par.scan_path = [raw_path 'hereon02_ptnet02_c']; ADD

% hereon03_ptnet03_c: tomo.rot_axis_offset at 2 x binning : -5.250000
par.scan_path = [raw_path 'hereon03_ptnet03_c']; ADD

par.scan_path = [raw_path 'hereon01_ptnet01_d']; ADD
par.scan_path = [raw_path 'hereon02_ptnet02_d']; ADD
par.scan_path = [raw_path 'hereon03_ptnet03_d']; ADD

par.scan_path = [raw_path 'hereon04_ptnet04_c']; ADD
par.scan_path = [raw_path 'hereon04_ptnet04_d']; ADD

par.scan_path = [raw_path 'hereon05_ptnet05_c']; ADD
par.scan_path = [raw_path 'hereon05_ptnet05_d']; ADD

par.scan_path = [raw_path 'hereon06_ptnet06_c']; ADD
par.scan_path = [raw_path 'hereon06_ptnet06_d']; ADD

par.scan_path = [raw_path 'hereon07_ptnet07_c']; ADD
par.scan_path = [raw_path 'hereon07_ptnet07_d']; ADD

par.scan_path = [raw_path 'hereon08_ptnet08_c']; ADD
par.scan_path = [raw_path 'hereon08_ptnet08_d']; ADD

interactive_mode.rot_axis_pos = 1; % reconstruct slices with dif+ferent rotation axis offsets
tomo.rot_axis_search_auto = 0; 
par.scan_path = [raw_path 'hereon01_ptnet01_hb_e']; ADD
par.scan_path = [raw_path 'hereon02_ptnet02_hb_e']; ADD
par.scan_path = [raw_path 'hereon03_ptnet03_hb_e']; ADD
par.scan_path = [raw_path 'hereon04_ptnet04_hb_e']; ADD
par.scan_path = [raw_path 'hereon05_ptnet05_hb_e']; ADD
par.scan_path = [raw_path 'hereon06_ptnet06_hb_e']; ADD
par.scan_path = [raw_path 'hereon07_ptnet07_hb_e']; ADD
par.scan_path = [raw_path 'hereon08_ptnet08_hb_e']; ADD
