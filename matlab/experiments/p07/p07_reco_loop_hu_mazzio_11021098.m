function p07_reco_loop_hu_mazzio_11021098( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 16-Jun-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11021098/raw/';

par.scan_path = [raw_path 'hereon_p07_2025_05']; ADD

par.scan_path = [raw_path 'hub001_c8cf1_ocv']; ADD

par.scan_path = [raw_path 'hub002_c2LiCu2_50thch_1p4V']; ADD

par.scan_path = [raw_path 'hub003_c3LiCu_50thch_1p4V']; ADD

par.scan_path = [raw_path 'hub004_c4Li2Cu_50thch_1p4V']; ADD

par.scan_path = [raw_path 'hub005_c2LiCu2_50thch_1p8V']; ADD

par.scan_path = [raw_path 'hub006_c3LiCu_50thch_1p8V']; ADD

par.scan_path = [raw_path 'hub007_c4Li2Cu_50thch_1p8V']; ADD

par.scan_path = [raw_path 'hub008_c5CuS0p08_50thdis_1p0V']; ADD

par.scan_path = [raw_path 'hub009_c5CuS0p08_50thdis_1p0V']; ADD

par.scan_path = [raw_path 'hub010_c8CF1_1stdis_1p0V']; ADD

par.scan_path = [raw_path 'hub011_c9CF50_50thdis_1p0V']; ADD

par.scan_path = [raw_path 'hub012_c6CuS0p5_50thdis_1p0V']; ADD

par.scan_path = [raw_path 'hub013_c7CuS1p0_50thdis_1p0V']; ADD

par.scan_path = [raw_path 'hub014_c2LiCu2_50th_2p38V']; ADD

par.scan_path = [raw_path 'hub015_c4Li2Cu_50th_2p38V']; ADD

par.scan_path = [raw_path 'hub016_c1CuS1p75_50thdis_0p5V']; ADD

par.scan_path = [raw_path 'hub017_c3LiCu_50thch_2p38V']; ADD

par.scan_path = [raw_path 'hub018_c5CuS0p08_50thdis_0p5V']; ADD

par.scan_path = [raw_path 'hub019_c7CuS1p0_50thch_1p9V']; ADD

par.scan_path = [raw_path 'hub020_c8CF1_1stdis_0p7V']; ADD

par.scan_path = [raw_path 'hub021_c8CF1_1stdis_0p08V']; ADD

par.scan_path = [raw_path 'hub022_c9CF50_50thdis_0p7V']; ADD

par.scan_path = [raw_path 'hub023_c6CuS0p5_50thdis_0p5V']; ADD

par.scan_path = [raw_path 'hub024_c2LiCu2_50thdis_1p2V']; ADD

par.scan_path = [raw_path 'hub025_c5CuS0p08_50thdis_0p08V']; ADD

par.scan_path = [raw_path 'hub026_c3LiCu_50thdis_1p2V']; ADD

par.scan_path = [raw_path 'hub027_c4Li2Cu_50thdis_1p2V']; ADD

par.scan_path = [raw_path 'hub028_c6CuS0p5_50thch_1p75V']; ADD

par.scan_path = [raw_path 'hub029_c7CuS1p0_50thch_1p9V']; ADD

par.scan_path = [raw_path 'hub030_c8CF1_1stch_1p2V']; ADD

par.scan_path = [raw_path 'hub031_c2LiCu2_50thdis_0p7V']; ADD

par.scan_path = [raw_path 'hub032_c3LiCu_50thdis_0p7V']; ADD

par.scan_path = [raw_path 'hub033_c9CF50_50thdis_0p08V']; ADD

par.scan_path = [raw_path 'hub034_c5CuS0p08_50thch_1p75V']; ADD

par.scan_path = [raw_path 'hub035_c4Li2Cu_50thdis_0p7V']; ADD

par.scan_path = [raw_path 'hub036_c1CuS1P75_50thdis_0p08V']; ADD

par.scan_path = [raw_path 'hub037_c1CuS1P75_50thch_1p75V']; ADD

par.scan_path = [raw_path 'hub038_c1CuS1P75_50thch_1p75V']; ADD

par.scan_path = [raw_path 'hub039_c7CuS1P0_50thch_2p38V']; ADD

par.scan_path = [raw_path 'hub040_c6CuS0P5_50thch_1p9V']; ADD

par.scan_path = [raw_path 'hub041_c2LiCu2_50thdis_0p08V']; ADD

par.scan_path = [raw_path 'hub042_c8CF1_1stch_1p6V']; ADD

par.scan_path = [raw_path 'hub043_c9CF50_50thch_1p2V']; ADD

par.scan_path = [raw_path 'hub044_c5CuS0p08_50thch_1p9V']; ADD

par.scan_path = [raw_path 'hub045_c8CF1_1stch_2p38V']; ADD

par.scan_path = [raw_path 'hub046_c5CuS0p08_50thch_2p38V']; ADD

par.scan_path = [raw_path 'hub047_c6CuS0p5_50thch_2p38V']; ADD

par.scan_path = [raw_path 'hub048_c4Li2Cu_50thdis_0p08V']; ADD

par.scan_path = [raw_path 'hub049_c3LiCu_50thdis_0p08V']; ADD

par.scan_path = [raw_path 'hub050_c9CF50_50thch_1p6V']; ADD

par.scan_path = [raw_path 'hub051_c8CF1_2nddis_1p0V']; ADD

par.scan_path = [raw_path 'hub052_c8CF1_2nddis_0p7V']; ADD

par.scan_path = [raw_path 'hub053_c9CF50_50thch_2p38V']; ADD

par.scan_path = [raw_path 'hub054_c8CF1_2ndch_2p38V']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_000']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_001']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_002']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_003']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_004']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_005']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_006']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_007']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_008']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_009']; ADD

par.scan_path = [raw_path 'hub055_op_c9cf50_010']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_000']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_001']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_002']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_003']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_004']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_005']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_006']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_007']; ADD

par.scan_path = [raw_path 'hub056_op_c9cf50_008']; ADD

par.scan_path = [raw_path 'hub057_op_c9cf50_000']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_000']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_001']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_002']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_003']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_004']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_005']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_006']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_007']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_008']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_009']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_010']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_011']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_012']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_013']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_014']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_015']; ADD

par.scan_path = [raw_path 'hub058_op_c8cf1_016']; ADD

par.scan_path = [raw_path 'test000']; ADD
