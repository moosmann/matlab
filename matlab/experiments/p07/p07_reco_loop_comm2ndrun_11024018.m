function p07_reco_loop_comm2ndrun_11024018( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 13-Oct-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11024018/raw/';

par.scan_path = [raw_path '00001_hereon_zn_no01_a']; ADD
par.scan_path = [raw_path '00001_hereon_zn_no01_b']; ADD
par.scan_path = [raw_path '00001_hereon_zn_no01_c']; ADD
par.scan_path = [raw_path '00001_hereon_zn_no01_d']; ADD

par.scan_path = [raw_path '00002_hereon_zn_no02_a']; ADD
par.scan_path = [raw_path '00003_hereon_zn_no02_b']; ADD

par.scan_path = [raw_path '00003_hereon_zn_no03_a']; ADD

par.scan_path = [raw_path '00004_hereon_zn_no04_zs70a_a']; ADD

par.scan_path = [raw_path '00005_hereon_zn_no05_a']; ADD

par.scan_path = [raw_path '00006_hereon_zn_no04_tzs20a_b']; ADD

par.scan_path = [raw_path '00007_hereon_zn_no06_a']; ADD
...
par.scan_path = [raw_path '00030_batt_samsung_b']; ADD
par.scan_path = [raw_path '00031_batt_samsung_c']; ADD
par.scan_path = [raw_path '00032_batt_samsung_d']; ADD
par.scan_path = [raw_path '00033_batt_samsung_e']; ADD
par.scan_path = [raw_path '00034_batt_samsung_f']; ADD

%% batt molicel DONE
par.scan_path = [raw_path '00035_batt_molicel_a']; ADD

par.scan_path = [raw_path '00036_batt_molicel_fly_a']; ADD
par.scan_path = [raw_path '00036_batt_molicel_fly_b']; ADD
par.scan_path = [raw_path '00037_batt_molicel_fly_c']; ADD
par.scan_path = [raw_path '00037_batt_molicel_fly_d']; ADD

% Defekt
%par.scan_path = [raw_path '00038_lsf_steel_93_9_a']; ADD
%par.scan_path = [raw_path '00039_lsf_steel_93_9_b']; ADD
%par.scan_path = [raw_path '00040_lsf_steel_93_9_c']; ADD

%% lsf steel
par.ring_current_normalization = 0;
par.raw_roi = [0 1 0.1 0.9];

par.scan_path = [raw_path '00041_lsf_steel_93_9_a']; ADD
tomo.rot_axis_offset = 50.2 / 2 * par.raw_bin;
par.scan_path = [raw_path '00042_lsf_steel_93_9_b']; ADD
par.scan_path = [raw_path '00043_lsf_steel_93_9_c']; ADD

%% hereon
par.scan_path = [raw_path '00044_hereon_ras_sa1_a']; ADD
par.scan_path = [raw_path '00045_hereon_ras_sa1_b']; ADD
par.scan_path = [raw_path '00046_hereon_ras_sa1_c']; ADD
par.scan_path = [raw_path '00047_hereon_ras_sa1_a']; ADD
par.scan_path = [raw_path '00048_hereon_ras_sa1_b']; ADD
par.scan_path = [raw_path '00049_hereon_ras_sa1_c']; ADD
...
tomo.rot_axis_offset = 2.6 / 2 * par.raw_bin;
par.scan_path = [raw_path '00050_lsf_al_bronze_tested_a']; ADD
tomo.rot_axis_offset = 2.4 / 2 * par.raw_bin;
par.scan_path = [raw_path '00051_lsf_al_bronze_tested_b']; ADD
tomo.rot_axis_offset = 2.0 / 2 * par.raw_bin;
par.scan_path = [raw_path '00052_lsf_al_bronze_tested_c']; ADD

%p = '/asap3/petra3/gpfs/p07/2025/data/11024018/processed/';
%stitch_volumes({[p '00051_lsf_al_bronze_tested_b'],[p '00050_lsf_al_bronze_tested_a'],[p '00052_lsf_al_bronze_tested_c']},'reco','float_rawBin2',[p 'lsf_al_bronze_tested'])

%% isf al
par.scan_path = [raw_path '00053_isf_al_a']; ADD
par.scan_path = [raw_path '00053_isf_al_b']; ADD
par.scan_path = [raw_path '00054_isf_al_b']; ADD
par.scan_path = [raw_path '00055_isf_al_c']; ADD

%% alsimg DONE
par.scan_path = [raw_path '00056_alsimg_a']; ADD

%% weld DONE
par.pixel_scaling = 1-0.0045;
phase_retrieval.apply = 0;
par.ring_current_normalization = 0;
par.raw_roi = [0 1 0.1 0.9];
image_correlation.area_width = [-100 -1];
image_correlation.method = 'median'; 'ssim-ml';
interactive_mode.rot_axis_pos = 0; 

tomo.rot_axis_offset = 2.8 / 2 * par.raw_bin;
par.scan_path = [raw_path '00056_weld_5013_a']; ADD
tomo.rot_axis_offset = 2.7 / 2 * par.raw_bin;
par.scan_path = [raw_path '00056_weld_5013_b']; ADD
tomo.rot_axis_offset = 3.0 / 2 * par.raw_bin;
par.scan_path = [raw_path '00056_weld_5013_c']; ADD

tomo.rot_axis_offset = 2.5 / 2 * par.raw_bin;
par.scan_path = [raw_path '00057_weld_5014_a']; ADD
tomo.rot_axis_offset = 2.3 / 2 * par.raw_bin;
par.scan_path = [raw_path '00057_weld_5014_b']; ADD
tomo.rot_axis_offset = 2.9 / 2 * par.raw_bin;
par.scan_path = [raw_path '00057_weld_5014_c']; ADD

tomo.rot_axis_offset = 3.0 / 2 * par.raw_bin;
par.scan_path = [raw_path '00058_weld_5015_a']; ADD
tomo.rot_axis_offset = 2.8 / 2 * par.raw_bin;
par.scan_path = [raw_path '00058_weld_5015_b']; ADD
tomo.rot_axis_offset = 3.2 / 2 * par.raw_bin;
par.scan_path = [raw_path '00058_weld_5015_c']; ADD

%stitch_volumes({'/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00056_weld_5013_b','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00056_weld_5013_a','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00056_weld_5013_c'},'reco','float_rawBin2','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00056_weld_5013')
%stitch_volumes({'/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00057_weld_5014_b','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00057_weld_5014_a','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00057_weld_5014_c'},'reco','float_rawBin2','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00057_weld_5014')
%stitch_volumes({'/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00058_weld_5015_b','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00058_weld_5015_a','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00058_weld_5015_c'},'reco','float_rawBin2','/asap3/petra3/gpfs/p07/2025/data/11024018/processed/00058_weld_5015');

%% batterie DONE
par.raw_bin = 4;
tomo.vol_size = [-1 1 -1 1 -0.5 0.5];
proc_path = '/asap3/petra3/gpfs/p07/2025/data/11024018/processed/';
par.scan_path = [proc_path  'batt_molicel_step'];
par.nexus_path = '/asap3/petra3/gpfs/p07/2025/data/11024018/raw/00035_batt_molicel_a';
...
tomo.vol_size = [];
proc_path = '/asap3/petra3/gpfs/p07/2025/data/11024018/processed/';
par.scan_path = [proc_path  'alsimg'];
par.nexus_path = '/asap3/petra3/gpfs/p07/2025/data/11024018/raw/00056_alsimg_a';
%par.nexus_path = [regexprep(par.scan_path,'processed','raw') '__a'];
par.read_sino = 1; 
