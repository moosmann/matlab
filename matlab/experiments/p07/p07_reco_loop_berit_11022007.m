function p07_reco_loop_berit_11022007( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 27-Oct-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11022007/raw/';

par.raw_bin = 2; 
par.raw_roi = -1;
par.stitch_projections = 1;
par.stitch_align_overlap = 0;
%write.subfolder_reco = 'reco3'; 
tomo.vol_size = [-0.95 0.95 -0.95 0.95 -0.5 0.5];
tomo.rot_axis_offset = 1150 / 2 * par.raw_bin;
interactive_mode.rot_axis_pos = 0;

par.scan_path = [raw_path '00000_lsf_al_bronze_tested_1_5_1_a']; ADD

par.scan_path = [raw_path '00000_lsf_al_bronze_tested_1_5_1_b']; ADD

par.scan_path = [raw_path '00001_lsf_al_bronze_tested_1_5_1_b']; ADD

par.scan_path = [raw_path '00002_lsf_al_bronze_tested_1_5_1_c']; ADD

par.scan_path = [raw_path '00003_lsf_al_bronze_tested_1_5_4_a']; ADD

par.scan_path = [raw_path '00004_lsf_al_bronze_tested_1_5_4_b']; ADD

par.scan_path = [raw_path '00005_lsf_al_bronze_tested_1_5_4_c']; ADD

par.scan_path = [raw_path '00006_lsf_al_bronze_tested_1_5_5_a']; ADD

par.scan_path = [raw_path '00006_lsf_al_bronze_tested_1_5_5_b']; ADD

par.scan_path = [raw_path '00007_lsf_al_bronze_tested_1_5_5_b']; ADD

par.scan_path = [raw_path '00008_lsf_al_bronze_tested_1_5_5_c']; ADD

par.scan_path = [raw_path '00009_lsf_al_bronze_untested_1_6_4_a']; ADD

par.scan_path = [raw_path '00010_lsf_al_bronze_untested_1_6_4_b']; ADD

par.scan_path = [raw_path '00011_lsf_al_bronze_untested_1_6_4_c']; ADD

par.scan_path = [raw_path '00012_lsf_al_bronze_untested_1_6_8_a']; ADD

par.scan_path = [raw_path '00013_lsf_al_bronze_untested_1_6_8_b']; ADD

par.scan_path = [raw_path '00014_lsf_al_bronze_untested_1_6_8_c']; ADD

par.scan_path = [raw_path '00015_cdma_lnkn1_a']; ADD

par.scan_path = [raw_path '00016_cdma_lnkn1_b']; ADD

par.scan_path = [raw_path '00017_cdma_lnkn1_c']; ADD

par.scan_path = [raw_path '00018_cdma_691li']; ADD

par.scan_path = [raw_path '00019_cdma_691re']; ADD

par.scan_path = [raw_path '00020_cdma_1255rem_a']; ADD

par.scan_path = [raw_path '00021_cdma_1255rem_b']; ADD

par.scan_path = [raw_path '00022_cdma_1255rem_c']; ADD

par.scan_path = [raw_path '00023_cdma_1255rem_d']; ADD

par.scan_path = [raw_path '00024_cdma_1255rem_e']; ADD

par.scan_path = [raw_path '00025_cdma_1255rem_f']; ADD

par.scan_path = [raw_path '00026_cdma_1255rem_g']; ADD

par.scan_path = [raw_path '00027_cdma_1892.7_a']; ADD

par.scan_path = [raw_path '00028_cdma_1892.7_b']; ADD

par.scan_path = [raw_path '00029_cdma_1892.9_a']; ADD

par.scan_path = [raw_path '00030_cdma_1892.9_b']; ADD

par.scan_path = [raw_path '00031_cdma_1892.9_c']; ADD

par.scan_path = [raw_path '00032_cdma_1892.1_a']; ADD

par.scan_path = [raw_path '00033_cdma_1892.1_b']; ADD

par.scan_path = [raw_path '00034_cdma_1886.41_a']; ADD

par.scan_path = [raw_path '00035_cdma_1886.41_b']; ADD

par.scan_path = [raw_path '00036_cdma_1886.37_a']; ADD

par.scan_path = [raw_path '00037_cdma_1886.37_b']; ADD

par.scan_path = [raw_path '00038_cdma_1886.44_a']; ADD

par.scan_path = [raw_path '00039_cdma_1886.44_b']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_000']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_001']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_002']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_003']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_004']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_005']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_006']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_007']; ADD

par.scan_path = [raw_path '0040_test_k1.3n_dpc_008']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_000']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_001']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_002']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_003']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_004']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_005']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_006']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_007']; ADD

par.scan_path = [raw_path '0041_cdma_rebl_b1_dpc_008']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_000']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_001']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_002']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_003']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_004']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_005']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_006']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_007']; ADD

par.scan_path = [raw_path '0042_daniel_24025_c6_dpc_008']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_000']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_001']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_002']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_003']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_004']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_005']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_006']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_007']; ADD

par.scan_path = [raw_path '0043_cdma_24025_T12_dpc_008']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_000']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_001']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_002']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_003']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_004']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_005']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_006']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_007']; ADD

par.scan_path = [raw_path '0044_cdma_rebl_a1_dpc_008']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_000']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_001']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_002']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_003']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_004']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_005']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_006']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_007']; ADD

par.scan_path = [raw_path '0045_cdma_rebl_b2_dpc_008']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_000']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_001']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_002']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_003']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_004']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_005']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_006']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_007']; ADD

par.scan_path = [raw_path '0046_cdma_24025_T8_dpc_008']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_000']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_001']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_002']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_003']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_004']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_005']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_006']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_007']; ADD

par.scan_path = [raw_path '0047_cdma_24025_L1_dpc_008']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_000']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_001']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_002']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_003']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_004']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_005']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_006']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_007']; ADD

par.scan_path = [raw_path '0048_cdma_24025_C7_dpc_008']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_000']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_001']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_002']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_003']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_004']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_005']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_006']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_007']; ADD

par.scan_path = [raw_path '0049_cdma_24025_L2_a_dpc_008']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_000']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_001']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_002']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_003']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_004']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_005']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_006']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_007']; ADD

par.scan_path = [raw_path '0050_cdma_rebl_a2_a_dpc_008']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_000']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_001']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_002']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_003']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_004']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_005']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_006']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_007']; ADD

par.scan_path = [raw_path '0051_cdma_rebl_a2_b_dpc_008']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_000']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_001']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_002']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_003']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_004']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_005']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_006']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_007']; ADD

par.scan_path = [raw_path '0052_cdma_24025_L2_b_dpc_008']; ADD

par.scan_path = [raw_path 'hereon_p07_2025_10']; ADD
