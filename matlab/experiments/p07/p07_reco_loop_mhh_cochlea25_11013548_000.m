function p07_reco_loop_mhh_cochlea25_11013548_000( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
tomo.rot_axis_search_range = [10:0.1:11]; % search reach for automatic determination of the rotation axis offset, overwrite interactive result if not empty
