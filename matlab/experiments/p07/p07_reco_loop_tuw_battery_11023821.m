function p07_reco_loop_tuw_battery_11023821( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 01-Jun-2026 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2026/data/11023821/raw/';

par.scan_path = [raw_path 'tuw001_R2']; ADD

par.scan_path = [raw_path 'tuw002_R1']; ADD

par.scan_path = [raw_path 'tuw003_Si1']; ADD

par.scan_path = [raw_path 'tuw004_Si2']; ADD

par.scan_path = [raw_path 'tuw005_Si2_z030']; ADD

par.scan_path = [raw_path 'tuw007_R2_z030']; ADD

par.scan_path = [raw_path 'tuw008_R1_z030']; ADD

par.scan_path = [raw_path 'tuw009_Si1_z030']; ADD
