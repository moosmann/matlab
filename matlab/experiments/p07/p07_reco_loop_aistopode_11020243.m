function p07_reco_loop_aistopode_11020243( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 18-Oct-2024 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
proc_path = '/asap3/petra3/gpfs/p07/2024/data/11020243/processed/';
raw_path = '/asap3/petra3/gpfs/p07/2024/data/11020243/raw/';
...
tomo.vol_size = [];
write.parfolder = '';
write.subfolder_reco = 'reco_filtered';
write.outputformat = 'tif';
par.verbose = 1;
par.distortion_correction_distance = 0;
tomo.reco_mode = 'slice';

tomo.vol_size =[];[-0.6 0.6 -0 0.5 -0.5 0.5];
par.strong_abs_thresh = 1e-6;

par.read_sino_range = [];
%par.read_sino_range = 0.5;[0.495 0.505];
par.read_sino_range = [151 7380];

par.scan_path = [proc_path 'aistopode'];
par.nexus_path = '/asap3/petra3/gpfs/p07/2024/data/11020243/raw/004_aistopode__a';
%[regexprep(par.scan_path,'processed','raw') '__a'];
par.read_sino = 1; 
...
pixel_filter_sino.threshold_hot = 0.01;
pixel_filter_sino.threshold_dark = 0.01;
...
par.scan_path = [raw_path '004_aistopode__b'];
par.nexus_path = '';
par.raw_roi = [0.45 0.55];
par.read_sino = 0;
%par.strong_abs_thresh = 1e-5;
%write.subfolder_reco = sprintf('neglogsaf_%u', -log10(par.strong_abs_thresh));
par.strong_abs_thresh = 1e-7;
write.subfolder_reco = '';
pixel_filter_radius = [5 5]; % Increase only if blobs of zeros or other artefacts are expected. Can increase processing time heavily.
pixel_filter_threshold_dark = [0.01 0.005];
pixel_filter_threshold_flat = [0.02 0.005];
pixel_filter_threshold_proj = [0.02 0.01];
write.to_scratch = 1;
tomo.rot_axis_offset = 981.0 / 2 * par.raw_bin; 
ADD

par.scan_path = [raw_path '003_aistopode__c'];
ADD
