function p07_reco_loop_hereon_fk_11020366( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 31-May-2024 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2024/data/11020366/raw/';
proc_path = '/asap3/petra3/gpfs/p07/2024/data/11020366/processed/';
...
par.scan_path = [proc_path 'fk0103_s3_a']; par.nexus_path = regexprep(par.scan_path,'processed','raw'); ADD 

par.scan_path = [proc_path 'fk0104_s4_a']; par.nexus_path = regexprep(par.scan_path,'processed','raw'); ADD 

par.scan_path = [proc_path 'fk0105_s5_a']; par.nexus_path = regexprep(par.scan_path,'processed','raw'); ADD 

par.scan_path = [proc_path 'fk0106_s6_a']; par.nexus_path = regexprep(par.scan_path,'processed','raw'); ADD 

par.scan_path = [proc_path 'fk0107_s7_a']; par.nexus_path = regexprep(par.scan_path,'processed','raw'); ADD 

par.scan_path = [proc_path 'fk0108_s8_a']; par.nexus_path = regexprep(par.scan_path,'processed','raw'); ADD 

par.scan_path = [proc_path 'fk0109_s09_a']; par.nexus_path = regexprep(par.scan_path,'processed','raw'); ADD 
...
tomo.rot_axis_search_auto = 1;
tomo.rot_axis_search_range = 0.5 + (-2:0.1:2);
tomo.rot_axis_search_metric = 'neg';
tomo.rot_axis_search_extrema = 'min'; 
tomo.rot_axis_search_fit = 0;
...
par.scan_path = [raw_path 'fk0117_fly_s17_b']; ADD
par.scan_path = [raw_path 'fk0118_fly_s18_b']; ADD
par.scan_path = [raw_path 'fk0119_fly_s19_a']; ADD

par.scan_path = [raw_path 'fk0120_fly_s20_a']; ADD
par.scan_path = [raw_path 'fk0121_fly_s21_a']; ADD
par.scan_path = [raw_path 'fk0122_fly_s22_a']; ADD

par.scan_path = [raw_path 'fk0220_fly_e37_s20_a']; ADD
par.scan_path = [raw_path 'fk0221_fly_e37_s21_a']; ADD
par.scan_path = [raw_path 'fk0222_fly_e37_s22_a']; ADD

par.scan_path = [raw_path 'fk0320_fly_e51_s20_a']; ADD
par.scan_path = [raw_path 'fk0321_fly_e51_s21_a']; ADD
