function p07_commissioning_20210928_11013374( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
% Created on 29-Sep-2021 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2021/data/11013374/raw/';
...
% ISS alloys
% 300 mm
tomo.rot_axis_offset = 30 / 2 * par.raw_bin;
par.scan_path = [raw_path 'hereon01_alag01_a']; ADD
%30 mm
tomo.rot_axis_offset = 0.5 / 2 * par.raw_bin;
par.scan_path = [raw_path 'hereon01_alag01_b']; ADD

image_correlation.method = 'ssim-ml'; 
write.subfolder_reco = 'imcor_ssim-ml';
ADD
image_correlation.method = 'median'; 
write.subfolder_reco = 'imcor_median';
ADD
...
par.scan_path = [raw_path 'hereon02_ptnet01_a']; ADD
par.scan_path = [raw_path 'hereon02_ptnet01_b']; ADD
par.scan_path = [raw_path 'hereon03_ptnet02_a']; ADD
par.scan_path = [raw_path 'hereon04_ptnet03_a']; ADD
par.scan_path = [raw_path 'hereon05_ptnet04_a']; ADD
par.scan_path = [raw_path 'hereon06_ptnet05_a']; ADD
par.scan_path = [raw_path 'hereon07_ptnet06_a']; ADD
par.scan_path = [raw_path 'hereon08_ptnet07_a']; ADD
par.scan_path = [raw_path 'hereon09_ptnet08_a']; ADD
par.scan_path = [raw_path 'hereon09_ptnet08_b']; ADD
