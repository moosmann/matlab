function p07_reco_loop_itaw_11020415( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 10-Dec-2024 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2024/data/11020415/processed/';

par.scan_path = [raw_path 'itaw009_427a_ut_1569_pp_a_0']; ADD

par.scan_path = [raw_path 'itaw021_cet_503b_pb_25039']; ADD

par.scan_path = [raw_path 'itaw001_tu_3a_uh_cc']; ADD

par.scan_path = [raw_path 'itaw003_tu_8b_uh_cm']; ADD

par.scan_path = [raw_path 'itaw009_427a_ut_1569_pp']; ADD
