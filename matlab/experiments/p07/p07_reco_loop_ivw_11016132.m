function p07_reco_loop_ivw_11016132( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 28-Aug-2023 by moosmanj
...
write.outputformat = 'hdf_volume';'tif';'hdf_slice'; % string. Not yet implemented for all reco modes
%%% INTERACTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
par.quick_switch = 0;
raw_path = '/asap3/petra3/gpfs/p07/2023/data/11016132/raw/';

par.raw_bin = 3; 

image_correlation.area_height = [0.4 0.6];
tomo.reco_mode = '3D';
write.deleteFiles = 0;
write.beamtimeID = '11016132';

interactive_mode.rot_axis_pos = 0;
tomo.rot_axis_offset_metric_roi = [];

tomo.rot_axis_search_auto = 1; % find extrema of metric within search range
tomo.rot_axis_search_range = -3:0.25:1.5; % search reach for automatic determination of the rotation axis offset, overwrite interactive result if not empty
...
tomo.rot_axis_search_range = -0.5 + (-1.5:0.25:1.5);
tomo.vol_size = [-0.3 0.2 -0.0 0.5 -0.5 0.5];
%tomo.vol_size = [-0.3 0.2 -0.5 0.25 -0.5 0.5];
%tomo.rot_axis_offset = -1.1 / 3 * par.raw_bin;
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_000']; ADD
%tomo.rot_axis_offset = -0.5 / 3 * par.raw_bin;
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_001']; ADD
%tomo.rot_axis_offset = -0.25 / 3 * par.raw_bin;
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_002']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_003']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_004']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_005']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_006']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_007']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_008']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_009']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_010']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_011']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_012']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_013']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_014']; ADD
par.scan_path = [raw_path '008_ivw_s06_b_p_1_s06_015']; ADD

tomo.vol_size = [-0.25 0.25 -0.2 0.3 -0.5 0.5];
par.scan_path = [raw_path '010_ivw_s06_b_p_2_s06_000']; ADD
par.scan_path = [raw_path '010_ivw_s06_b_p_2_s06_001']; ADD
par.scan_path = [raw_path '010_ivw_s06_b_p_2_s06_002']; ADD
% hdf5 error
par.ring_current_normalization = 0; 
par.scan_path = [raw_path '010_ivw_s06_b_p_2_s06_003']; ADD %%%%%%%%%%%%%%%
par.ring_current_normalization = 1; 
%tomo.vol_size = [-0.25 0.25 -0.2 0.3 -0.5 0.5];
%% Was the sample remounted? Then the reco roi for 10-12 can be adjuted
par.scan_path = [raw_path '011_ivw_s06_b_p_2_s06_000']; ADD
par.scan_path = [raw_path '012_ivw_s06_b_p_2_s06_000']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_000']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_001']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_002']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_003']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_004']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_005']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_006']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_007']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_008']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_009']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_010']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_011']; ADD
par.scan_path = [raw_path '013_ivw_s06_b_p_2_s06_012']; ADD

tomo.vol_size = [-0.25 0.25 0 0.5 -0.5 0.5];
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_000']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_001']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_002']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_003']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_004']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_005']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_006']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_007']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_008']; ADD
par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_009']; ADD
% no images
% par.scan_path = [raw_path '014_ivw_s04_b_p_3_s04_010']; ADD

tomo.vol_size = [-0.3 0.2 0 0.5 -0.5 0.5];
tomo.rot_axis_search_range = 0 + (-2.0:0.25:2.0);
par.scan_path = [raw_path '015_ivw_s04_b_p_3_s04_000']; ADD
par.scan_path = [raw_path '015_ivw_s04_b_p_3_s04_001']; ADD
par.scan_path = [raw_path '015_ivw_s04_b_p_3_s04_002']; ADD
% h5 error
par.ring_current_normalization = 0; 
par.scan_path = [raw_path '015_ivw_s04_b_p_3_s04_003']; ADD %%%%%%%%%%%%%%%
par.ring_current_normalization = 1; 
par.scan_path = [raw_path '015_ivw_s04_b_p_3_s04_004']; ADD

tomo.vol_size = [0.0 0.5 -0.5 0.0 -0.5 0.5];
tomo.rot_axis_search_range = 0.5 + (-2.0:0.25:2.0);
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_000']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_001']; ADD
% h5 error
par.ring_current_normalization = 0;
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_002']; ADD
par.ring_current_normalization = 1; 
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_003']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_004']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_005']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_006']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_007']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_008']; ADD
% Auto proc fails
tomo.rot_axis_offset = 0.55 / 3 * par.raw_bin;
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_009']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_010']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_011']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_012']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_013']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_014']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_015']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_016']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_017']; ADD
par.scan_path = [raw_path '016_ivw_s04_g_p_4_s04_018']; ADD

tomo.rot_axis_search_range = 1.5 + (-2:0.25:2);
tomo.vol_size = [-0.5 0.0 0.0 0.5 -0.5 0.5];
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_000']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_001']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_002']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_003']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_004']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_005']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_006']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_007']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_008']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_009']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_010']; ADD
% h5 error
par.ring_current_normalization = 0; 
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_011']; ADD %%%%%%%%%%%%%%%
par.ring_current_normalization = 1; 
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_012']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_013']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_014']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_015']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_016']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_017']; ADD
par.scan_path = [raw_path '017_ivw_s05_g_p_5_s05_018']; ADD

tomo.vol_size = [-0.5 0.0 -0.2 0.3 -0.5 0.5];
tomo.rot_axis_search_range = 1.0 + (-2:0.25:2);
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_000']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_001']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_002']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_003']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_004']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_005']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_006']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_007']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_008']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_009']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_010']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_011']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_012']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_013']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_014']; ADD
par.scan_path = [raw_path '019_ivw_s05_p_p_6_s05_015']; ADD

tomo.vol_size = [-0.5 0.0 0 0.5 -0.5 0.5];
tomo.rot_axis_search_range = 1.5 + (-2.25:0.25:2.25);
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_000']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_001']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_002']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_003']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_004']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_005']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_006']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_007']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_008']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_009']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_010']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_011']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_012']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_013']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_014']; ADD
par.scan_path = [raw_path '020_ivw_s03_p_p_7_s03_015']; ADD

tomo.vol_size = [-0.5 0 -0.4 0.1 -0.5 0.5];
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_000']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_001']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_002']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_003']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_004']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_005']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_006']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_007']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_008']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_009']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_010']; ADD
par.scan_path = [raw_path '021_ivw_R_g_p_8_R_011']; ADD

tomo.vol_size = [-0.5 0 -0.5 0 -0.5 0.5];
par.scan_path = [raw_path '022_ivw_R_g_p_8_R_000']; ADD
par.scan_path = [raw_path '022_ivw_R_g_p_8_R_001']; ADD

tomo.vol_size = [-0.5 0 -0.4 0.1 -0.5 0.5];
tomo.rot_axis_search_range = 1.5 + (-2:0.25:2);
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_000']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_001']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_002']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_003']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_004']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_005']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_006']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_007']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_008']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_009']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_010']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_011']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_012']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_013']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_014']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_015']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_016']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_017']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_018']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_019']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_020']; ADD
par.scan_path = [raw_path '023_ivw_S03_p_p_9_S03_021']; ADD

tomo.vol_size = [-0.5 0 -0.1 0.4 -0.5 0.5];
tomo.rot_axis_search_range = 1.75 + (-2:0.25:2);
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_000']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_001']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_002']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_003']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_004']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_005']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_006']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_007']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_008']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_009']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_010']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_011']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_012']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_013']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_014']; ADD
par.scan_path = [raw_path '024_ivw_S06_b_p_10_S06_015']; ADD

tomo.vol_size = [-0.5 0 0 0.5 -0.5 0.5];
tomo.rot_axis_search_range = 1 + (-2:0.25:2);
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_000']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_001']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_002']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_003']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_004']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_005']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_006']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_007']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_008']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_009']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_010']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_011']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_012']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_013']; ADD
par.scan_path = [raw_path '025_ivw_S05_p_p_11_S05_014']; ADD

tomo.vol_size = [-0.25 0.25 -0.25 0.25 -0.5 0.5];
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_000']; ADD
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_001']; ADD
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_002']; ADD
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_003']; ADD
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_004']; ADD
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_005']; ADD
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_006']; ADD
par.scan_path = [raw_path '026_ivw_R_p_p_12_R_007']; ADD

tomo.vol_size = [-0.15 0.35 -0.15 0.35 -0.5 0.5];
tomo.rot_axis_search_range = 6.25 + (-2:0.25:2);
par.scan_path = [raw_path '027_ivw_s02_roh_p_13_s02_000']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_000']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_001']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_002']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_003']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_004']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_005']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_006']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_007']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_008']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_009']; ADD
par.scan_path = [raw_path '028_ivw_s02_roh_p_13_s02_010']; ADD

tomo.vol_size = [-0.25 0.25 -0.25 0.25 -0.5 0.5];
tomo.rot_axis_search_range = 6.25 + (-2:0.25:2);
par.scan_path = [raw_path '029_ivw_s02_roh_p_14_s02_000']; ADD
par.scan_path = [raw_path '029_ivw_s02_roh_p_14_s02_001']; ADD
par.scan_path = [raw_path '029_ivw_s02_roh_p_14_s02_002']; ADD
par.scan_path = [raw_path '029_ivw_s02_roh_p_14_s02_003']; ADD
par.scan_path = [raw_path '029_ivw_s02_roh_p_14_s02_004']; ADD
