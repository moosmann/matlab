function p07_reco_loop_mbs_11022780( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 13-Jun-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11022780/raw/';

par.raw_bin = 4;
par.raw_roi = -3; 
par.proj_range = 10002:20002;
par.ref_range = 5;
write.flatcor = 1; 
par.crop_proj = 1; 
image_correlation.area_width = [1 200];% 2-vector. correlation area: index vector or relative/absolute position of [first pix,last pix],negative indexing is supported
image_correlation.area_height = [0 1]; % 2/vector. correlation area [bottom top]: index vector or relative/absolute position of [first pix,last pix]
par.scan_path = [raw_path 'hereon01_mbs_test']; ADD

par.scan_path = [raw_path 'hereon02_mbs_mg_a']; ADD
