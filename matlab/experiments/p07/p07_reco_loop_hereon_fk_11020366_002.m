function p07_reco_loop_hereon_fk_11020366_002( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
par.scan_path = [raw_path 'fk0101_s1_a']; ADD

par.scan_path = [raw_path 'fk0101_s1_b']; ADD

par.scan_path = [raw_path 'fk0102_s2_b']; ADD

par.scan_path = [raw_path 'fk0103_s3_a']; ADD

par.scan_path = [raw_path 'fk0104_s4_a']; ADD

par.scan_path = [raw_path 'fk0105_s5_a']; ADD

par.scan_path = [raw_path 'fk0106_s6_a']; ADD

par.scan_path = [raw_path 'fk0107_s7_a']; ADD

par.scan_path = [raw_path 'fk0108_s8_a']; ADD

par.scan_path = [raw_path 'fk0109_s09_a']; ADD

par.scan_path = [raw_path 'fk0110_s10_a']; ADD

par.scan_path = [raw_path 'fk0111_s11_a']; ADD

par.scan_path = [raw_path 'fk0112_s12_a']; ADD

par.scan_path = [raw_path 'fk0113_s13_a']; ADD

par.scan_path = [raw_path 'fk0114_s14_a']; ADD

par.scan_path = [raw_path 'fk0115_s15_a']; ADD

par.scan_path = [raw_path 'fk0116_s16_a']; ADD

par.scan_path = [raw_path 'fk0116_s16_b']; ADD
