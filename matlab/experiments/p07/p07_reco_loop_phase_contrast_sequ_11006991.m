function p07_reco_loop_phase_contrast_sequ_11006991( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 04-Jul-2024 by moosmanj
...
%par.scan_path = [raw_path 'syn001_Ti_12w_47R']; ADD
%par.scan_path = [raw_path 'syn002_Ti_12w_47R_z0140_t130ms']; ADD
%par.scan_path = [raw_path 'syn004_Ti_12w_47R_z0280_t130ms']; ADD
...
write.deleteFiles = 0;
write.beamtimeID = '11006991';
par.read_image_log = 1;
par.read_filenames_from_disk = 0;
par.energy = 88e3;
par.ring_current_normalization = 1; 
par.raw_roi = [0.2 0.8];

pixel_filter_threshold_dark = [0.02 0.005];
pixel_filter_threshold_flat = [0.05 0.005];
pixel_filter_threshold_proj = [0.05 0.005];
pixel_filter_radius = [11 11];


par.scan_path = [raw_path 'syn005_Ti_12w_47R_z0030_t001ms']; ADD

par.scan_path = [raw_path 'syn006_Ti_12w_47R_z0030_t005ms']; ADD

par.scan_path = [raw_path 'syn007_Ti_12w_47R_z0030_t010ms']; ADD

par.scan_path = [raw_path 'syn008_Ti_12w_47R_z0030_t135ms']; ADD

par.scan_path = [raw_path 'syn009_Ti_12w_47R_z0140_t001ms']; ADD

par.scan_path = [raw_path 'syn010_Ti_12w_47R_z0140_t005ms']; ADD

par.scan_path = [raw_path 'syn011_Ti_12w_47R_z0140_t010ms']; ADD

par.scan_path = [raw_path 'syn012_Ti_12w_47R_z0140_t135ms']; ADD

par.scan_path = [raw_path 'syn013_Ti_12w_47R_z0280_t001ms']; ADD

par.scan_path = [raw_path 'syn014_Ti_12w_47R_z0280_t005ms']; ADD

par.scan_path = [raw_path 'syn015_Ti_12w_47R_z0280_t010ms']; ADD

par.scan_path = [raw_path 'syn016_Ti_12w_47R_z0280_t135ms']; ADD

par.scan_path = [raw_path 'syn017_Ti_12w_47R_z0560_t001ms']; ADD

par.scan_path = [raw_path 'syn018_Ti_12w_47R_z0560_t005ms']; ADD

par.scan_path = [raw_path 'syn019_Ti_12w_47R_z0560_t010ms']; ADD

par.scan_path = [raw_path 'syn020_Ti_12w_47R_z0560_t135ms']; ADD

par.scan_path = [raw_path 'syn021_Ti_12w_47R_z1120_t001ms']; ADD

par.scan_path = [raw_path 'syn022_Ti_12w_47R_z1120_t005ms']; ADD

par.scan_path = [raw_path 'syn023_Ti_12w_47R_z1120_t010ms']; ADD

par.scan_path = [raw_path 'syn024_Ti_12w_47R_z1120_t135ms']; ADD
