function p07_reco_loop_mhh_cochlea25_11013548_001( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 22-Nov-2021 by moosmanj
...
par.read_image_log = 1; % bool, default: 0. Read metadata from image log instead hdf5, if image log exists
%%% PREPROCESSING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
tomo.rot_axis_search_range = 8.5:0.25:12.5; % search reach for automatic determination of the rotation axis offset, overwrite interactive result if not empty
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2021/data/11013548/raw/';

par.scan_path = [raw_path 'hereon03_mhh_cochlea25_a']; ADD

par.scan_path = [raw_path 'hereon03_mhh_cochlea25_b']; ADD

par.scan_path = [raw_path 'hereon03_mhh_cochlea25_c']; ADD

par.scan_path = [raw_path 'hereon03_mhh_cochlea25_d']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_a']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_b']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_c']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_d']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_e']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_f']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_g']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_h']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_i']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_j']; ADD

par.scan_path = [raw_path 'hereon04_mhh_cochlea25_k']; ADD


par.wo_crop = 0;

par.read_image_log = 0; 
par.stitch_projections = 1; 
par.stitch_method = 'sine'; 'step';'linear'; 
ring_filter.apply = 1; 
...
tomo.rot_axis_search_auto = 1;
tomo.rot_axis_search_range = 793.5:0.25:797.5;
...
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_a']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_b']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_c']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_d']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_e']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_f']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_g']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_h']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_i']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_j']; ADD
par.scan_path = [raw_path 'hereon06_mhh_cochlea25_fly_k']; ADD
