function p07_reco_loop_hereon_gst_11018402( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 23-Apr-2024 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2024/data/11018402/raw/';


par.raw_bin = 2; 
par.raw_roi = [];
image_correlation.method = 'ssim-ml';%'median';
ring_filter.apply = 1; 
phase_retrieval.apply = 0;
phase_retrieval.reg_par = 1.2;
% bottom
tomo.rot_axis_offset = 0.1 / 2 * par.raw_bin;
% middle
tomo.rot_axis_offset = 0.8 / 2 * par.raw_bin;
% top
...
tomo.rot_axis_search_range = -1:0.1:3; % search reach for automatic determination of the rotation axis offset, overwrite interactive result if not empty
...
tomo.vol_shape = [2560 2560 800];

par.scan_path = [raw_path 'gst0018_9bar_sh1_full_13'];
ADD

par.scan_path = [raw_path 'gst0019_9bar_sh1_full_01'];
tomo.rot_axis_offset = 0.6 / 2 * par.raw_bin;
ADD

angles = load('/asap3/petra3/gpfs/p07/2024/data/11018402/processed/gst0019_9bar_sh1_full_01/reco/angles.mat','angles');
par.ring_current_normalization = 0;
angles = angles.angles;
tomo.rot_angle_full_range = angles;

par.scan_path = [raw_path 'gst0019_9bar_sh1_full_02'];
tomo.rot_axis_offset = 0.25 / 2 * par.raw_bin;
ADD
 
par.ring_current_normalization = 1;
par.scan_path = [raw_path 'gst0020_9bar_sh1_full_03'];
tomo.rot_axis_offset = 0.7 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_04'];
tomo.rot_axis_offset = 0.8 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_05'];
tomo.rot_axis_offset = 0.6 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_06'];
tomo.rot_axis_offset = 0.9 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_07'];
tomo.rot_axis_offset = 1.0 / 2 * par.raw_bin;
par.ring_current_normalization = 0;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_08'];
par.ring_current_normalization = 1;
tomo.rot_axis_offset = 1.0 / 2 * par.raw_bin;ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_09'];
tomo.rot_axis_offset = 1.8 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_10'];
tomo.rot_axis_offset = 1.6 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_11'];
tomo.rot_axis_offset = 1.6 / 2 * par.raw_bin;
ADD
  
par.scan_path = [raw_path 'gst0020_9bar_sh1_full_12'];
tomo.rot_axis_offset = 2.2 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_13'];
tomo.rot_axis_offset = 2.2 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_14'];
tomo.rot_axis_offset = 2.4 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'gst0020_9bar_sh1_full_15'];
...
par.scan_path = [raw_path 'gst0021_V_sh1_full_03']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_04']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_05']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_06']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_07']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_08']; ADD
...
par.scan_path = [raw_path 'gst0021_V_sh1_full_12']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_13']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_14']; ADD

par.scan_path = [raw_path 'gst0021_V_sh1_full_15']; ADD

par.scan_path = [raw_path 'gst002_40bar_sh5_top']; ADD

par.scan_path = [raw_path 'gst003_40bar_sh2_bottom']; ADD

par.scan_path = [raw_path 'gst003_40bar_sh2_middle']; ADD

par.scan_path = [raw_path 'gst003_40bar_sh2_top']; ADD

par.scan_path = [raw_path 'gst004_40bar_sh3_bottom']; ADD

par.scan_path = [raw_path 'gst004_40bar_sh3_middle']; ADD

par.scan_path = [raw_path 'gst004_40bar_sh3_top']; ADD

par.scan_path = [raw_path 'gst005_9bar_sh4_bottom']; ADD

par.scan_path = [raw_path 'gst006_9bar_sh4_bottom']; ADD

par.scan_path = [raw_path 'gst006_9bar_sh4_middle']; ADD

par.scan_path = [raw_path 'gst006_9bar_sh4_top']; ADD

par.scan_path = [raw_path 'gst007_9bar_sh5_bottom']; ADD

par.scan_path = [raw_path 'gst007_9bar_sh5_middle']; ADD

par.scan_path = [raw_path 'gst007_9bar_sh5_top']; ADD

par.scan_path = [raw_path 'gst008_V_sh4_bottom']; ADD

par.scan_path = [raw_path 'gst008_V_sh4_middle']; ADD

par.scan_path = [raw_path 'gst008_V_sh4_top']; ADD

par.scan_path = [raw_path 'gst009_V_sh5_bottom']; ADD

par.scan_path = [raw_path 'gst009_V_sh5_middle']; ADD

par.scan_path = [raw_path 'gst009_V_sh5_top']; ADD

par.scan_path = [raw_path 'gst0017_40bar_sh1_full_06']; ADD

par.scan_path = [raw_path 'gst0016_1atm_shref_bottom']; ADD

par.scan_path = [raw_path 'gst0017_40bar_sh1_full_08']; ADD

par.scan_path = [raw_path 'gst0017_40bar_sh1_full_07']; ADD
