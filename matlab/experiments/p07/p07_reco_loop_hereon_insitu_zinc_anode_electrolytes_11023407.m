function p07_reco_loop_hereon_insitu_zinc_anode_electrolytes_11023407( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 25-Apr-2026 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2026/data/11023407/raw/';
...
tomo.rot_axis_search_range = 2.0 + (-3.5:0.2:3.5); % search reach for automatic determination of the rotation axis offset,overwrite interactive result if not empty
tomo.rot_axis_search_metric = 'iso-grad'; % string: 'neg','entropy','iso-grad','laplacian','entropy-ML','abs'. Metric to find rotation axis offset
tomo.rot_axis_search_extrema = 'max'; % string: 'min'/'max'. chose min or maximum position
...
par.scan_path = [raw_path 'hereon_01_ig']; ADD

par.scan_path = [raw_path 'hereon_02_ZS']; ADD

par.scan_path = [raw_path 'hereon_03_ano']; ADD

par.scan_path = [raw_path 'hereon_04_ano']; ADD

par.scan_path = [raw_path 'hereon_05_ano_a']; ADD

%% REDO
par.scan_path = [raw_path 'hereon_05_ano_b']; ADD

par.scan_path = [raw_path 'hereon_06_ano']; ADD

par.scan_path = [raw_path 'hereon_07_cat']; ADD

par.scan_path = [raw_path 'hereon_07_cat_a']; ADD

par.scan_path = [raw_path 'hereon_08_ano']; ADD

par.scan_path = [raw_path 'hereon_09_ano']; ADD

par.scan_path = [raw_path 'hereon_10_zn_matrix_3mm']; ADD

par.scan_path = [raw_path 'hereon_11_zn_matrix']; ADD

par.scan_path = [raw_path 'hereon_12_zn_after_an_3mm']; ADD

par.scan_path = [raw_path 'hereon_13_zn_after_an']; ADD

par.scan_path = [raw_path 'hereon_14_zn_after_ca']; ADD

par.scan_path = [raw_path 'hereon_15_zn_after_ca_3mm']; ADD

par.scan_path = [raw_path 'hereon_16_fe1_a']; ADD

par.scan_path = [raw_path 'hereon_16_fe1_b']; ADD

par.scan_path = [raw_path 'hereon_16_fe1_c']; ADD

par.scan_path = [raw_path 'hereon_16_fe1_d']; ADD

par.scan_path = [raw_path 'hereon_17_fe2_a']; ADD

par.scan_path = [raw_path 'hereon_17_fe2_b']; ADD

par.scan_path = [raw_path 'hereon_17_fe2_c']; ADD

par.scan_path = [raw_path 'hereon_17_fe2_d']; ADD
