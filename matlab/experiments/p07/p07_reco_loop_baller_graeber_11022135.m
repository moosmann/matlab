function p07_reco_loop_baller_graeber_11022135( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 08-Dec-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11022135/raw/';

par.raw_bin = 2; 

par.scan_path = [raw_path 'hu258_m02_scan01']; ADD

par.scan_path = [raw_path 'hu328_m01_scan01']; ADD

par.scan_path = [raw_path 'hu329_m01_scan02']; ADD

par.scan_path = [raw_path 'hu329_m01_scan03']; ADD

par.scan_path = [raw_path 'hu331_m01_scan04']; ADD

par.scan_path = [raw_path 'hu332_m01_scan05']; ADD

par.scan_path = [raw_path 'hu333_m01_scan06']; ADD

par.scan_path = [raw_path 'hu334_m01_scan07']; ADD

par.scan_path = [raw_path 'hu335_m01_scan08']; ADD

par.scan_path = [raw_path 'hu335_m01_scan09']; ADD

par.scan_path = [raw_path 'hu337_m01_scan10']; ADD

par.scan_path = [raw_path 'hu338_m01_scan11']; ADD

par.scan_path = [raw_path 'hu339_m01_scan12']; ADD

par.scan_path = [raw_path 'hu340_m01_scan13']; ADD

par.scan_path = [raw_path 'hu341_m01_scan14']; ADD

par.scan_path = [raw_path 'hu342_m01_scan15']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+000']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+0000']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+001']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+002']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+003']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+004']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+005']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+006']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+007']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+008']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+009']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+010']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+011']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+012']; ADD

par.scan_path = [raw_path 'hu343-358_m01_scan16+013']; ADD

par.scan_path = [raw_path 'hu351_n01_scan01']; ADD

par.scan_path = [raw_path 'hu359_m02_scan01000']; ADD

par.scan_path = [raw_path 'hu360_m02_scan02000']; ADD

par.scan_path = [raw_path 'hu362_m03_scan01']; ADD

par.scan_path = [raw_path 'hu363_m03_scan02']; ADD

par.scan_path = [raw_path 'hu364_m03_scan03']; ADD

par.scan_path = [raw_path 'hu365_m03_scan04']; ADD

par.scan_path = [raw_path 'hu366_m03_scan05']; ADD

par.scan_path = [raw_path 'hu367_m03_scan06']; ADD

par.scan_path = [raw_path 'hu368_m03_scan07']; ADD

par.scan_path = [raw_path 'hu368_m03_scan077']; ADD

par.scan_path = [raw_path 'hu370_m03_scan09']; ADD

par.scan_path = [raw_path 'hu371_n02_scan02']; ADD

par.scan_path = [raw_path 'hu372_m03_scan09']; ADD

par.scan_path = [raw_path 'hu373_m03_scan11']; ADD

par.scan_path = [raw_path 'hu374_m03_scan12'];
rot_axis_offset = par.raw_bin / 2 * 0.500000;
ring_filter.apply = 1; 
par.raw_roi = [131 1130 671 6050];
...
write.subfolder_reco = 'all_stripe';
ADD


par.scan_path = [raw_path 'hu375_m03_scan13']; ADD

par.scan_path = [raw_path 'hu376_m03_scan14']; ADD

par.scan_path = [raw_path 'hu377_m03_scan15']; ADD

par.scan_path = [raw_path 'hu378_mO01_scan01']; ADD

par.scan_path = [raw_path 'hu379_n02_scan03']; ADD

par.scan_path = [raw_path 'hu380_m05_scan01']; ADD

par.scan_path = [raw_path 'hu381_m05_scan02']; ADD

par.scan_path = [raw_path 'hu382_m05_scan03']; ADD

par.scan_path = [raw_path 'hu383_n02_scan03']; ADD

par.scan_path = [raw_path 'hu384_o02_scan01']; ADD

par.scan_path = [raw_path 'hu385_o02_scan02']; ADD

par.scan_path = [raw_path 'hu386_o02_scan03']; ADD

par.scan_path = [raw_path 'hu387_n02_scan04']; ADD

par.scan_path = [raw_path 'hu388_o02_scan04']; ADD

par.scan_path = [raw_path 'hu389_m04_scan01']; ADD

par.scan_path = [raw_path 'hu389_n01_scan02']; ADD

par.scan_path = [raw_path 'hu391_o02_scan05']; ADD

par.scan_path = [raw_path 'hu392_o02_scan06']; ADD

par.scan_path = [raw_path 'hu393_m06_scan01']; ADD

par.scan_path = [raw_path 'hu393_m06_scan02']; ADD

par.scan_path = [raw_path 'hu395_m06_scan03']; ADD

par.scan_path = [raw_path 'hu396_n01_scan03']; ADD

par.scan_path = [raw_path 'hu397_m06_scan04']; ADD

par.scan_path = [raw_path 'hu398_m06_scan05']; ADD

par.scan_path = [raw_path 'hu399_m06_scan06']; ADD

par.scan_path = [raw_path 'hu400_m06_scan07']; ADD

par.scan_path = [raw_path 'hu401_m06_scan08']; ADD

par.scan_path = [raw_path 'hu402_n01_scan04']; ADD

par.scan_path = [raw_path 'hu403_m06_scan09']; ADD

par.scan_path = [raw_path 'hu404_m06_scan10']; ADD

par.scan_path = [raw_path 'hu405_m06_scan11']; ADD

par.scan_path = [raw_path 'hu406_n01_scan04']; ADD

par.scan_path = [raw_path 'hu407_m06_scan12']; ADD

par.scan_path = [raw_path 'hu408_m06_scan13']; ADD

par.scan_path = [raw_path 'hu409_o03000']; ADD

par.scan_path = [raw_path 'hu409_o03001']; ADD

par.scan_path = [raw_path 'hu409_o03002']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_000']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_001']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_002']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_003']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_004']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_005']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_006']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_007']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_008']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_009']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_010']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_011']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_012']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_013']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_014']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_015']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_016']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_017']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_018']; ADD

par.scan_path = [raw_path 'hu410_o03_contious_019']; ADD

par.scan_path = [raw_path 'hu411_o03_zchange']; ADD

par.scan_path = [raw_path 'hu412_o03_zchange_scan2']; ADD
