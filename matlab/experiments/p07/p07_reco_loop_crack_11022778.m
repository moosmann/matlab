function p07_reco_loop_crack_11022778( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 09-May-2025 by moosmanj
...
pixel_filter_sino.medfilt_neighboorhood = [11 11];
...
par.raw_roi = -4; % vertical and/or horizontal ROI; coordinate (1,1) = top left pixel; supports absolute, relative, negative, and mixed indexing.
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11022778/raw/';
image_correlation.method = 'median';


par.scan_path = [raw_path 'hereon01_kit_iam_fe_crack_a']; ADD

par.scan_path = [raw_path 'hereon02_kit_iam_fe_crack_a']; ADD
...
par.scan_path = [raw_path 'hereon03_kit_iam_fe_crack_c2']; ADD

par.scan_path = [raw_path 'hereon03_kit_iam_fe_crack_d']; ADD

par.scan_path = [raw_path 'hereon03_kit_iam_fe_crack_d2']; ADD

par.scan_path = [raw_path 'hereon03_kit_iam_fe_crack_e']; ADD

par.scan_path = [raw_path 'hereon04_kit_iam_fe_crack_e2']; ADD

par.scan_path = [raw_path 'hereon04_kit_iam_fe_crack_f']; ADD

par.scan_path = [raw_path 'hereon04_kit_iam_fe_crack_g']; ADD
