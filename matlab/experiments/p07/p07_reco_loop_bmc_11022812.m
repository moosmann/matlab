function p07_reco_loop_bmc_11022812( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 06-May-2025 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11022812/raw/';

%par.scan_path = [raw_path 'bmc001_cartilage2h']; ADD

%par.scan_path = [raw_path 'bmc001_cartilage2h_350mm_ppc']; ADD
...
par.scan_path = [raw_path 'bmc002_cartilage2h_1000mm_ppc']; 
tomo.rot_axis_offset = 87.25 / 2 * par.raw_bin; 
ADD

par.distortion_correction_distance = 1620; 
par.distortion_correction_exponent = 2;

par.distortion_correction_outer_offset = 86.25;
write.subfolder_reco = regexprep(sprintf('distCor%07.3f',par.distortion_correction_outer_offset),'\.','p');
ADD

par.distortion_correction_outer_offset = 85.25;
write.subfolder_reco = regexprep(sprintf('distCor%07.3f',par.distortion_correction_outer_offset),'\.','p');
ADD

par.distortion_correction_outer_offset = 88.25;
write.subfolder_reco = regexprep(sprintf('distCor%07.3f',par.distortion_correction_outer_offset),'\.','p');
ADD

par.distortion_correction_outer_offset = 89.25;
write.subfolder_reco = regexprep(sprintf('distCor%07.3f',par.distortion_correction_outer_offset),'\.','p');
ADD
