function p07_reco_loop_fossil_jaw_delatorre_11021050( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 17-Jun-2025 by moosmanj
...
%%% TOMOGRAPHY %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tomo.run = 1; % run tomographic reconstruction, use e.g. to find rot axis positions in a loop script without running the reco to the end
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2025/data/11021050/raw/';
write.flatcor = 0;

% OK KIT
par.scan_path = [raw_path 'csic001_T94L0_1_m2m1_z1350mm_103keV_fast']; ADD
...
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_a2']; ADD
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_a3']; ADD
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_a4']; ADD

par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_b0']; ADD
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_b1']; ADD
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_b2']; ADD
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_b3']; ADD
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_b4']; ADD

% reco OKish, but proj at 0/2pi differ
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_c0']; ADD
par.scan_path = [raw_path 'csic003_T94L0_1_m2_m3_c1']; ADD

% strong movement
image_correlation.method = 'median';
par.scan_path = [raw_path 'csic007_T94L0_1_m3_distal_al']; ADD
par.raw_bin = 4;
tomo.rot_axis_offset = -826 / 4 * par.raw_bin; 
par.proj_range = 1;[1:5,9995:10000];
interactive_mode.rot_axis_tilt = 1;
interactive_mode.lamino = 0;
par.scan_path = [raw_path 'csic008_T94L0_1_m3_distal_al']; ADD

% strong movement
tomo.rot_axis_offset = -0.75 / 4 * par.raw_bin; 
par.scan_path = [raw_path 'csic010_T94L0_m3_distal_fly']; ADD
...
par.scan_path = [raw_path 'csic011_T94L0_1_m3_distal_ar']; ADD

par.scan_path = [raw_path 'csic011_T94L0_m3_distal_fly']; ADD

% Movement 2/3 pixels diogonally
par.scan_path = [raw_path 'csic012_T94L0_1_m3_distal_bl']; ADD
% movement
par.scan_path = [raw_path 'csic013_T94L0_1_m3_distal_al']; ADD
% movement
par.scan_path = [raw_path 'csic013_T94L0_1_m3_distal_ar']; ADD
% movement
par.scan_path = [raw_path 'csic013_T94L0_1_m3_distal_bl']; ADD
par.scan_path = [raw_path 'csic013_T94L0_1_m3_distal_br']; ADD
par.scan_path = [raw_path 'csic013_T94L0_1_m3_distal_cl']; ADD
% movement
par.scan_path = [raw_path 'csic013_T94L0_1_m3_distal_cr']; ADD

par.scan_path = [raw_path 'csic014_T94L0_1_m3_distal_ar']; ADD
