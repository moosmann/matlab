function p07_reco_loop_swerim_11020251( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 19-Apr-2024 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2024/data/11020251/raw/';
tomo.rot_axis_offset = 0 / 2 * par.raw_bin;
image_correlation.method = 'ssim-ml';
par.ring_current_normalization = 0;

par.scan_path = [raw_path 'swerim001_Sura_C32_fly']; ADD

par.scan_path = [raw_path 'swerim001_Sura_C32_fly00']; ADD

par.scan_path = [raw_path 'swerim001_Sura_C32_fly01_300mm']; ADD

par.scan_path = [raw_path 'swerim002_Sura_C32_81keV_50mm_a']; ADD

par.scan_path = [raw_path 'swerim003_sa06_voestalpine_s1_a']; ADD

par.scan_path = [raw_path 'swerim004_sa01_ulrika_steel_a']; ADD

par.scan_path = [raw_path 'swerim005_sa03_sura_k32_a']; ADD


par.scan_path = [raw_path 'swerim006_sa03_sura_k32_b']; 
tomo.rot_axis_offset = -0.15 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim007_sa04_sura_b32_a']; 
tomo.rot_axis_offset = 0.75 / 2 * par.raw_bin;
ADD
 
par.scan_path = [raw_path 'swerim008_sa04_sura_b32_b'];
tomo.rot_axis_offset = -0.15 / 2 * par.raw_bin;
 ADD
 
par.scan_path = [raw_path 'swerim009_sa05_sura_b33_a'];
tomo.rot_axis_offset = -0.15 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim010_sa07_voestalpine_s2_a']; 
tomo.rot_axis_offset = 0.8   / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim011_sa07_voestalpine_s2_b'];
tomo.rot_axis_offset = 0.3 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim012_sa08_voestalpine_s3_a'];
tomo.rot_axis_offset = 0.2 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim013_sa08_voestalpine_s3_b']; 
tomo.rot_axis_offset = 0.3 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim014_sa09_voestalpine_s4_a'];
tomo.rot_axis_offset = 0.5 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim015_sa10_voestalpine_s5_a'];
tomo.rot_axis_offset = 0.3 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim016_sa11_voestalpine_s6_a'];
tomo.rot_axis_offset = 1.0 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim017_sa12_voestalpine_s7_a'];
tomo.rot_axis_offset = 0.0 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim018_sa12_voestalpine_s7_b']; 
tomo.rot_axis_offset = 0.2 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim019_sa16_huawei_steel_a'];
tomo.rot_axis_offset = 0.7 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim020_sa15_huawei_bronze_a']; 
tomo.rot_axis_offset = 1.0 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim021_sa14_coromant975_a']; 
tomo.rot_axis_offset = 0.25 / 2 * par.raw_bin;
ADD

par.scan_path = [raw_path 'swerim022_sa02_sura_c32_round2_a'];
