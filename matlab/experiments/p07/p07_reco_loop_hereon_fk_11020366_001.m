function p07_reco_loop_hereon_fk_11020366_001( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
raw_path = '/asap3/petra3/gpfs/p07/2024/data/11020366/processed/';

par.scan_path = [raw_path 'fk0101_s1_b']; ADD

par.scan_path = [raw_path 'fk0102_s2_a']; ADD
...
par.scan_path = [raw_path 'fk0113_s14_a']; ADD
