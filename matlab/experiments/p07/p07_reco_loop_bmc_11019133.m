function p07_reco_loop_bmc_11019133( SUBSETS, RUN_RECO, PRINT_PARAMETERS)
...
%
% Created on 08-Feb-2024 by moosmanj
...
%% PARAMETER / DATA SETS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
proc_path = '/asap3/petra3/gpfs/p07/2023/data/11019133/processed/';
raw_path = '/asap3/petra3/gpfs/p07/2023/data/11019133/raw/';
...
%% bmc002_81718_mousebrain_202311_DESY 
par.scan_path = [proc_path 'bmc002_81718_mousebrain_202311_DESY']; ADD
par.scan_path = [proc_path 'bmc004_85681_mousebrain_202311_DESY']; ADD
par.scan_path = [proc_path 'bmc005_84225_mousebrain_202311_DESY']; ADD
par.scan_path = [proc_path 'bmc007_81513_mousebrain_202311_DESY']; ADD
par.scan_path = [proc_path 'bmc008_85679_mousebrain_202311_DESY']; ADD
par.scan_path = [proc_path 'bmc009_81212_mousebrain_202311_DESY']; 
par.nexus_path = [raw_path 'bmc009_81212_mousebrain_202311_DESY_height_a'];
phase_retrieval.apply = 0;
ADD
...
par.scan_path = [proc_path 'bmc010_84784_mousebrain_202311_DESY'];
par.nexus_path = [raw_path 'bmc010_84784_mousebrain_202311_DESY_height_a'];
phase_retrieval.apply = 0;
ADD
phase_retrieval.apply = 1;
phase_retrieval.reg_par = 1.0;
...
par.scan_path = [proc_path 'bmc010_84784_mousebrain_202311_DESY_height_a']; ADD

%%
par.scan_path = [proc_path 'bmc011_L43396_align01']; ADD
par.scan_path = [proc_path 'bmc011_L43396_align02']; ADD

par.scan_path = [proc_path 'bmc013_L43396_rabbit_fn_a_r1']; ADD
par.scan_path = [proc_path 'bmc013_L43396_rabbit_fn_b_r1']; ADD
par.scan_path = [proc_path 'bmc014_L43396_rabbit_fn_c_r1']; ADD
par.scan_path = [proc_path 'bmc014_L43396_rabbit_fn_d_r1']; ADD

par.scan_path = [proc_path 'bmc015_L43396_align04']; ADD
par.scan_path = [proc_path 'bmc015_L43396_align05']; ADD
par.scan_path = [proc_path 'bmc015_L43396_align06']; ADD

par.scan_path = [proc_path 'bmc016_L43396_rabbit_fn_right_a_r1']; ADD

par.scan_path = [proc_path 'bmc017_paraffinSliceB4']; ADD

par.scan_path = [proc_path 'bmc019_L43396_EtOH_align_leftEye01']; ADD
par.scan_path = [proc_path 'bmc019_L43396_EtOH_align_leftEye02']; ADD
par.scan_path = [proc_path 'bmc019_L43396_EtOH_align_leftEye03']; ADD
par.scan_path = [proc_path 'bmc019_L43396_EtOH_align_leftEye04']; ADD
par.scan_path = [proc_path 'bmc019_L43396_EtOH_align_leftEye05']; ADD
par.scan_path = [proc_path 'bmc019_L43396_EtOH_align_rightEye01']; ADD
par.scan_path = [proc_path 'bmc019_L43396_EtOH_align_rightEye02']; ADD

par.scan_path = [proc_path 'bmc020_L43396_rabbitEtOH_fn_right_a_r1']; ADD
par.scan_path = [proc_path 'bmc020_L43396_rabbitEtOH_fn_right_b_r1']; ADD
par.scan_path = [proc_path 'bmc021_L43396_rabbitEtOH_fn_right_c_r1']; ADD
par.scan_path = [proc_path 'bmc022_L43396_rabbitEtOH_fn_left_a_r1']; ADD
